...
(() => {
  ...
  function applyGlowEffectMode(enabled) {
    ...
    if (!playlistShow) {
      ...
      playlistCss = `.main-entityHeader-container.main-entityHeader-containerNormal { backdrop-filter: blur(1rem) !important; box-shadow: 0 0 25px 8px var(--glowify-glow-accent, var(--accent-color)) !important; outline: none !important; }`;
    } else {
  ...
  function updatePlaylistHeaderCss(show) {
    ...
    if (!show) {
      ...
      css = `.main-entityHeader-container.main-entityHeader-containerNormal { backdrop-filter: blur(1rem) !important; box-shadow: 0 0 25px 8px var(--glowify-glow-accent, var(--accent-color)) !important; outline: none !important; }`;
    } else {
...
.PromotionDefaultNative-module_card-container__Y90Vl:focus, .PromotionDefaultNative-module_card-container__Y90Vl:hover { backdrop-filter: blur(2rem) !important; }` : "";
  ...
  var glowifyTranslations = {
    ...
    hi: {
      ...
      canvasCoverArt: {
        ...
        off: "\u092C\u0902\u0926",
        trackInfo: "\u091F\u094D\u0930\u0948\u0915 \u0907\u0928\u094D\u092B\u094B \u0915\u0947 \u092A\u093E\u0938",
        outsideTrackInfo: "\u091F\u094D\u0930\u0948\u0915 \u0907\u0928\u094D\u092B\u094B \u0915\u0947 \u092C\u093E\u0939\u0930",
        overCanvas: "Canvas \u0915\u0947 \u090A\u092A\u0930",
        showAlways: "\u0939\u092E\u0947\u0936\u093E \u0926\u093F\u0916\u093E\u090F\u0901:",
        yes: "\u0939\u093E\u0901",
        no: "\u0928\u0939\u0940\u0902",
        blur: "\u0927\u0941\u0902\u0927\u0932\u093E\u092A\u0928 (px):"
      },
      ...
      tooltips: {
        ...
        tncaMode: "\u0926\u093E\u090F\u0901 \u0938\u093E\u0907\u0921\u092C\u093E\u0930 \u092E\u0947\u0902 \u091F\u094D\u0930\u0948\u0915 \u0928\u093E\u092E \u0915\u0947 \u092C\u0917\u0932 \u092E\u0947\u0902 \u0915\u0935\u0930 \u0906\u0930\u094D\u091F \u0926\u093F\u0916\u093E\u0924\u093E \u0939\u0948",
        tncaShowAlways: "Canvas \u0935\u0940\u0921\u093F\u092F\u094B \u0928 \u0939\u094B\u0928\u0947 \u092A\u0930 \u092D\u0940 \u0915\u0935\u0930 \u0906\u0930\u094D\u091F \u0939\u092E\u0947\u0936\u093E \u0926\u093F\u0916\u093E\u090F\u0901",
    ...
    ja: {
      ...
      tooltips: {
        ...
        tncaMode: "\u53F3\u30B5\u30A4\u30C9\u30D0\u30FC\u306E\u30C8\u30E9\u30C3\u30AF\u540D\u306E\u6A2A\u306B\u30AB\u30D0\u30FC\u30A2\u30FC\u30C8\u3092\u8868\u793A",
        tncaShowAlways: "Canvas\u52D5\u753B\u304C\u306A\u304F\u3066\u3082\u30AB\u30D0\u30FC\u30A2\u30FC\u30C8\u3092\u5E38\u306B\u8868\u793A",
        tncaBlur: "Canvas\u52D5\u753B\u4E0A\u306E\u307C\u304B\u3057\u306E\u5F37\u5EA6",
        highPerformance: "\u30AB\u30FC\u30C9\u306B\u30DB\u30D0\u30FC\u6642\u306E\u30D6\u30E9\u30FC\u52B9\u679C\u3092\u6709\u52B9\u306B\u3059\u308B",
    ...
    ko: {
      ...
      canvasCoverArt: {
        ...
        off: "\uB044\uAE30",
        trackInfo: "\uD2B8\uB799 \uC815\uBCF4 \uC606\uC5D0",
        outsideTrackInfo: "\uD2B8\uB799 \uC815\uBCF4 \uBC14\uAE65\uC5D0",
        overCanvas: "Canvas \uC704\uC5D0",
        showAlways: "\uD56D\uC0C1 \uD45C\uC2DC:",
        yes: "\uC608",
        no: "\uC544\uB2C8\uC624",
        blur: "\uD750\uB9BC (px):"
      ...
      tooltips: {
        ...
        tncaMode: "\uC624\uB978\uCABD \uC0AC\uC774\uB4DC\uBC14\uC758 \uD2B8\uB799 \uC774\uB984 \uC606\uC5D0 \uCEE4\uBC84 \uC544\uD2B8 \uD45C\uC2DC",
        tncaShowAlways: "Canvas \uB3D9\uC601\uC0C1\uC774 \uC5C6\uC5B4\uB3C4 \uD56D\uC0C1 \uCEE4\uBC84 \uC544\uD2B8 \uD45C\uC2DC",
        tncaBlur: "Canvas \uB3D9\uC601\uC0C1 \uC704\uC758 \uD750\uB9BC \uAC15\uB3C4",
        highPerformance: "\uCE74\uB4DC\uC5D0 \uD638\uBC84 \uBE14\uB7EC \uD6A8\uACFC \uD65C\uC131\uD654",
  ...
  var GLOWIFY_GEAR_HOST_SELECTOR = ".main-globalNav-contentRight";
