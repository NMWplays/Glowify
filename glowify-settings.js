...
(() => {
  ...
  function applyGlowEffectMode(enabled) {
    ...
    ` : `
      ...
      .glowifyColorSwatch { box-shadow: 0 0 25px 8px var(--glowify-glow-accent, var(--accent-color)) !important; border: none !important; outline: none !important; }
      ...
      .glowifyTooltipPopup { box-shadow: 0 0 18px 5px var(--glowify-glow-accent, var(--accent-color, rgba(30,215,96,0.35))) !important; }
    `;
