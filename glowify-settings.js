...
@keyframes yPSdY9z6bkI2272drRTw {
  ...
  function ensureBackgroundBrightnessApplied() {
    const saved = parseInt(localStorage.getItem("glowify-bg-brightness") || "80", 10);
  ...
  function SettingsContent(props) {
    ...
    const [bgBrightness, setBgBrightnessState] = React.useState(readNum("glowify-bg-brightness", 80));
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.backgroundBlur), /* @__PURE__ */ React.createElement(Stepper, { value: bgBlur, min: 0, max: 100, onChange: applyBlur })), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.backgroundBrightness || "Background Brightness:"), /* @__PURE__ */ React.createElement(Stepper, { value: bgBrightness, min: 0, max: 200, onChange: applyBgBrightness }))), /* @__PURE__ */ React.createElement(Section, { title: titles.artist }, /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.apbackground), /* @__PURE__ */ React.createElement("div", { className: "glowifyStackedControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
        value: artistBgMode,
        options: [
