...
(() => {
  ...
  function applyGlowEffectMode(enabled) {
    ...
    ` : `
      .glowifySectionTitle { box-shadow: none !important; outline: solid 1px var(--accent-color) !important; }
      .glowifySectionBody { box-shadow: none !important; outline: solid 1px var(--accent-color) !important; }
      .glowifyColorSwatch { box-shadow: none !important; outline: solid 1px var(--accent-color) !important; }
      .glowifyControlSurface { box-shadow: none !important; outline: solid 1px var(--accent-color) !important; }
      .glowifySettingsPanel { box-shadow: none !important; outline: solid 1px var(--accent-color) !important; }
      .glowifySelectMenu { box-shadow: none !important; outline: solid 1px var(--accent-color) !important; }
    `;
    ...
    if (!playlistShow) {
      ...
      playlistCss = `.main-entityHeader-container.gmKBgPCnX785KDicbdJu { backdrop-filter: blur(1rem) !important; box-shadow: none !important; outline: solid 1px var(--accent-color) !important; }`;
    }
  ...
  function updatePlaylistHeaderCss(show) {
    ...
    if (!show) {
      ...
      css = `.main-entityHeader-container.gmKBgPCnX785KDicbdJu { backdrop-filter: blur(1rem) !important; box-shadow: none !important; outline: solid 1px var(--accent-color) !important; }`;
    }
...
@keyframes yPSdY9z6bkI2272drRTw {
  ...
  var glowifyTranslations = {
    ...
    fr: {
      ...
      glowEffectMode: "Mode de luminosit\xE9:",
      ...
      artistScrollBlur: "Flou de d\xE9filement artiste (px):",
      artistScrollBrightness: "Luminosit\xE9 de d\xE9filement artiste (%):",
      close: "Fermer",
      ...
      lyricsOptions: {
        off: "D\xE9sactiv\xE9",
        translation: "Traduction seulement",
        romanization: "Romanisation seulement",
      ...
      sections: {
        ...
        playlist: "Playlist",
        lyrics: "Paroles",
        transparent: "Contr\xF4les Transparents"
      },
      glowOnOff: { on: "Activ\xE9", off: "D\xE9sactiv\xE9" }
    },
    pt: {
  ...
  function SettingsContent(props) {
    ...
    )))), /* @__PURE__ */ React.createElement(Section, { title: titles.glow }, /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.glowEffectMode), /* @__PURE__ */ React.createElement("div", { className: "glowifyRowControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.glowColor), /* @__PURE__ */ React.createElement("div", { className: "glowifyRowControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
        value: glowMode,
        options: [
    ...
    )))), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.backgroundBlur), /* @__PURE__ */ React.createElement(Stepper, { value: bgBlur, min: 0, max: 100, onChange: applyBlur }))), /* @__PURE__ */ React.createElement(Section, { title: titles.artist }, /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.apbackground), /* @__PURE__ */ React.createElement("div", { className: "glowifyStackedControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
        value: artistBgMode,
        options: [
    ...
    )))), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.artistScrollBlur || "Artist Scroll Blur (px):"), /* @__PURE__ */ React.createElement(Stepper, { value: artistScrollBlur, min: 0, max: 100, onChange: (v2) => {
      setArtistScrollBlur(v2);
      applyArtistScrollEffect(v2, artistScrollBrightness);
    } })), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.artistScrollBrightness || "Artist Scroll Brightness (%):"), /* @__PURE__ */ React.createElement(Stepper, { value: artistScrollBrightness, min: 0, max: 100, onChange: (v2) => {
    ...
    ))), /* @__PURE__ */ React.createElement(Section, { title: titles.lyrics }, /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.lyricsMode || "Lyrics-\xDCbersetzung/Romanisierung:"), /* @__PURE__ */ React.createElement("div", { className: "glowifyRowControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
        value: lyricsMode,
        options: [
