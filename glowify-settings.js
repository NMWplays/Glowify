...
(() => {
  ...
  var React;
  var ReactDOM;
  var GLOWIFY_POPOVER_CLOSE_TOP_PX = 341.313;
  function ensureSettingsUiStyle() {
    ...
    .glowifySettingsPanel {
      ...
      height: min(50vh, calc(100vh - 80px));
      max-height: min(50vh, calc(100vh - 80px));
      overflow: hidden;
      display: flex;
    ...
    .glowifyCloseBtn:hover { background: var(--accent-color) !important; }
    .glowifySettingsBody {
      flex: 1 1 auto;
      overflow-x: hidden;
      overflow-y: auto;
    ...
    .glowifyStepperBtn { width: 24px; height: 24px; border-radius: 9px; cursor: pointer; }
    ...
    .glowifyColorSwatch { width: 20px; height: 20px; border-radius: 6px; box-shadow: 0 0 25px 8px var(--accent-color); }
  ...
  function ColorPicker(props) {
    ...
    useLayout(() => {
      ...
      const recalc = () => {
        ...
        const bounds = panel ? panel.getBoundingClientRect() : { left: 0, top: 0, right: window.innerWidth, bottom: window.innerHeight };
        const controls = (_c = (_b = btn.closest) == null ? void 0 : _b.call(btn, ".glowifyRowControls")) != null ? _c : null;
        ...
        if (top <= GLOWIFY_POPOVER_CLOSE_TOP_PX) {
          setPos(null);
          setOpen(false);
          return;
        }
  ...
  function SettingsContent(props) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "glowifySettingsPanel" }, /* @__PURE__ */ React.createElement("div", { className: "glowifySettingsHeader" }, /* @__PURE__ */ React.createElement("h3", { className: "glowifySettingsTitle" }, t.title), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        className: "glowifyControlSurface glowifyCloseBtn",
