...
(() => {
  ...
  function SettingsContent(props) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "glowifySettingsPanel" }, /* @__PURE__ */ React.createElement("div", { className: "glowifySettingsHeader" }, /* @__PURE__ */ React.createElement("h3", { className: "glowifySettingsTitle" }, t.title), /* @__PURE__ */ React.createElement("div", { className: "glowifyHeaderActions" }, /* @__PURE__ */ React.createElement(ButtonTooltip, { text: "Discord" }, /* @__PURE__ */ React.createElement(
    ...
    } }))), /* @__PURE__ */ React.createElement(Section, { title: titles.canvasCoverArt || "Canvas Cover Art" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, ((_c = t.canvasCoverArt) == null ? void 0 : _c.mode) || "Track Name Cover Art:", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.tncaMode })), /* @__PURE__ */ React.createElement(
      Select,
      {
        value: npvcMode,
        options: [
          { value: "off", label: ((_d = t.canvasCoverArt) == null ? void 0 : _d.off) || "Off" },
          { value: "trackInfo", label: ((_e = t.canvasCoverArt) == null ? void 0 : _e.trackInfo) || "Next to Track Info" },
          { value: "outsideTrackInfo", label: ((_f = t.canvasCoverArt) == null ? void 0 : _f.outsideTrackInfo) || "Outside Track Info" },
          { value: "overCanvas", label: ((_g = t.canvasCoverArt) == null ? void 0 : _g.overCanvas) || "Over Canvas" }
        ],
        onChange: (v2) => {
          setNpvcMode(v2);
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, ((_h = t.canvasCoverArt) == null ? void 0 : _h.showAlways) || "Show Always:", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.tncaShowAlways })), /* @__PURE__ */ React.createElement(
      Select,
      {
        value: npvcShowAlways,
        options: [
          { value: "yes", label: ((_i = t.canvasCoverArt) == null ? void 0 : _i.yes) || "Yes" },
          { value: "no", label: ((_j = t.canvasCoverArt) == null ? void 0 : _j.no) || "No" }
        ],
        onChange: (v2) => {
    ...
    )), npvcMode === "overCanvas" && /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, ((_k = t.canvasCoverArt) == null ? void 0 : _k.blur) || "Blur (px):", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.tncaBlur })), /* @__PURE__ */ React.createElement(Stepper, { value: npvcBlur, min: 0, max: 50, onChange: (v2) => {
      setNpvcBlur(v2);
      ...
      Select,
      {
        value: lyricsMode,
        options: [
          { value: "off", label: ((_l = t.lyricsOptions) == null ? void 0 : _l.off) || "Aus" },
          { value: "translation", label: ((_m = t.lyricsOptions) == null ? void 0 : _m.translation) || "Nur \xDCbersetzung" },
          { value: "romanization", label: ((_n = t.lyricsOptions) == null ? void 0 : _n.romanization) || "Nur Romanisierung" },
          { value: "both", label: ((_o = t.lyricsOptions) == null ? void 0 : _o.both) || "\xDCbersetzung + Romanisierung" }
        ],
