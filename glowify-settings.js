...
(() => {
  ...
  function applyAccent(color) {
    ...
    button.e-10180-legacy-button-primary.e-10180-legacy-button:hover { --background-highlight: ${color} !important; }
    ...
    button.e-10310-legacy-button-primary.e-10310-legacy-button:hover { --background-highlight: ${color} !important; }
    .e-10451-legacy-button-primary:hover .e-10451-button-primary__inner { background-color: ${color} !important; }
    .encore-dark-theme .encore-inverted-light-set { --background-base: ${color} !important; }
    button.e-10180-legacy-chip.e-10180-legacy-chip--selected:hover .encore-inverted-light-set { --background-base: ${color} !important; }
    button.e-10310-legacy-chip.e-10310-legacy-chip--selected:hover .encore-inverted-light-set { --background-base: ${color} !important; }
    ...
    .e-10451-legacy-chip:hover > .e-10451-legacy-chip__inner.e-10451-legacy-chip__inner--selected { background-color: ${color} !important; }
  ...
  function resetAccentToDefault() {
    ...
    button.e-10180-legacy-button-primary.e-10180-legacy-button:hover { --background-highlight: #3be477 !important; }
    ...
    button.e-10310-legacy-button-primary.e-10310-legacy-button:hover { --background-highlight: #3be477 !important; }
    .e-10451-legacy-button-primary:hover .e-10451-button-primary__inner { background-color: #3be477; }
    .encore-dark-theme .encore-inverted-light-set { --background-base: #FFFFFF !important; }
    button.e-10180-legacy-chip.e-10180-legacy-chip--selected:hover .encore-inverted-light-set { --background-base: #FFFFFF !important; }
    button.e-10310-legacy-chip.e-10310-legacy-chip--selected:hover .encore-inverted-light-set { --background-base: #FFFFFF !important; }
    .e-10180-legacy-chip:hover > .e-10180-legacy-chip__inner.e-10180-legacy-chip__inner--selected { background-color: #f0f0f0 !important; }
    .e-10310-legacy-chip:hover > .e-10310-legacy-chip__inner.e-10310-legacy-chip__inner--selected { background-color: #f0f0f0 !important; }
    .e-10451-legacy-chip:hover > .e-10451-legacy-chip__inner.e-10451-legacy-chip__inner--selected { background-color: #f0f0f0 !important; }
  ...
  function resetGlowAccentToDefault() {
    document.documentElement.style.setProperty("--glowify-glow-accent", "var(--glowify-accent-raw, var(--accent-color))");
    localStorage.setItem("glowify-glow-mode", "default");
    window.dispatchEvent(new Event("glowifyAccentBoostChange"));
  }
  function resetAllGlowifySettings(onClose) {
    const prefixes = ["glowify-", "liquify-", "theme-nsc-"];
    const keys = [];
    for (let i2 = 0; i2 < localStorage.length; i2++) {
      const k = localStorage.key(i2);
      if (k && prefixes.some((p2) => k.startsWith(p2))) keys.push(k);
    }
    keys.forEach((k) => localStorage.removeItem(k));
    localStorage.setItem("glowify-onboarding-done", "1");
    const bodyEl = document.querySelector(".glowifySettingsPanel .glowifySettingsBody");
    ...
    try {
      ...
      window.dispatchEvent(new Event("glowifySettingsReload"));
    } catch (e) {
      console.error("Glowify reset failed", e);
    }
    const restore = () => {
      const el = document.querySelector(".glowifySettingsPanel .glowifySettingsBody");
  ...
  function applyGlowEffectMode(enabled) {
    ...
    const css = enabled ? `
      .glowifySectionTitle { box-shadow: 0 0 var(--glowify-glow-blur, 25px) var(--glowify-glow-spread, 8px) var(--glowify-glow-accent, var(--accent-color)) !important; border: none !important; outline: none !important; }
      .glowifySectionBody { box-shadow: 0 0 var(--glowify-glow-blur, 25px) var(--glowify-glow-spread, 8px) var(--glowify-glow-accent, var(--accent-color)) !important; border: none !important; outline: none !important; }
      .glowifyColorSwatch { box-shadow: 0 0 var(--glowify-glow-blur, 25px) var(--glowify-glow-spread, 8px) var(--glowify-glow-accent) !important; border: none !important; outline: none !important; }
      .glowifyControlSurface { box-shadow: 0 0 var(--glowify-glow-blur, 25px) var(--glowify-glow-spread, 8px) var(--glowify-glow-accent, var(--accent-color)) !important; border: none !important; outline: none !important; }
      .glowifySettingsPanel { box-shadow: 0 0 var(--glowify-glow-blur, 25px) var(--glowify-glow-spread, 8px) var(--glowify-glow-accent, var(--accent-color)) !important; border: none !important; outline: none !important; }
      .glowifySelectMenu { box-shadow: 0 0 var(--glowify-glow-blur, 25px) var(--glowify-glow-spread, 8px) var(--glowify-glow-accent, var(--accent-color)) !important; border: none !important; outline: none !important; }
    ` : `
    ...
    let playlistCss;
    if (!playlistShow) {
      playlistCss = `.main-entityHeader-container.main-entityHeader-containerNormal { backdrop-filter: none !important; box-shadow: none !important; outline: none !important; }`;
    } else if (enabled) {
      playlistCss = `.main-entityHeader-container.main-entityHeader-containerNormal { backdrop-filter: blur(1rem) !important; box-shadow: 0 0 var(--glowify-glow-blur, 25px) var(--glowify-glow-spread, 8px) var(--glowify-glow-accent, var(--accent-color)) !important; outline: none !important; }`;
    } else {
      playlistCss = `.main-entityHeader-container.main-entityHeader-containerNormal { backdrop-filter: blur(1rem) !important; box-shadow: none !important; outline: solid 1px var(--glowify-outline-accent, var(--accent-color)) !important; }`;
    }
  ...
  function applyGlowSize(blur, spread) {
    ...
    localStorage.setItem("glowify-glow-blur", String(blur));
    localStorage.setItem("glowify-glow-spread", String(spread));
  }
  function ensureGlowSizeApplied() {
    const blur = parseFloat(localStorage.getItem("glowify-glow-blur") || "25");
    const spread = parseFloat(localStorage.getItem("glowify-glow-spread") || "8");
    applyGlowSize(Number.isFinite(blur) ? blur : 25, Number.isFinite(spread) ? spread : 8);
  }
  ...
  function installCoverSwipe() {
    (() => {
      ...
      (_b = anyWin.__coverSwipeOff) == null ? void 0 : _b.call(anyWin);
    ...
    `;
      ...
      const trackToImageUrl = (t) => {
        ...
        const imgs = ((_a2 = ctx.album) == null ? void 0 : _a2.images) || ((_b2 = t.album) == null ? void 0 : _b2.images);
        if (Array.isArray(imgs) && ((_c2 = imgs[0]) == null ? void 0 : _c2.url)) return imgs[0].url;
        return "";
      };
      const trackToUri = (t) => {
        if (!t) return "";
      ...
      const getQueue = () => {
        var _a2, _b2, _c2, _d;
        return ((_a2 = anyWin.Spicetify) == null ? void 0 : _a2.Queue) || ((_d = (_c2 = (_b2 = anyWin.Spicetify) == null ? void 0 : _b2.Platform) == null ? void 0 : _c2.PlayerAPI) == null ? void 0 : _d._queue) || {};
      };
      const getCurrentItem = () => {
        var _a2, _b2;
        try {
          const data = (_b2 = (_a2 = anyWin.Spicetify) == null ? void 0 : _a2.Player) == null ? void 0 : _b2.data;
          return (data == null ? void 0 : data.item) || (data == null ? void 0 : data.track) || null;
        } catch (e) {
          return null;
        }
      };
      const getCurrentCoverUrl = () => {
        ...
        return ((_a2 = cont == null ? void 0 : cont.querySelector(".main-nowPlayingView-coverArt img")) == null ? void 0 : _a2.src) || ((_b2 = cont == null ? void 0 : cont.querySelector("img")) == null ? void 0 : _b2.src) || "";
      };
      ...
      const getNextItem = () => {
        ...
        try {
          const q2 = getQueue();
          return ((_a2 = q2.nextTracks) == null ? void 0 : _a2[0]) || ((_b2 = q2.next_tracks) == null ? void 0 : _b2[0]) || null;
        } catch (e) {
          return null;
        }
      };
      const getPrevItem = () => {
        try {
          ...
          return (arr == null ? void 0 : arr[arr.length - 1]) || null;
        } catch (e) {
          return null;
        }
      };
      ...
      const unmount = () => {
        ...
        canvasPoll = null;
        nextObserver == null ? void 0 : nextObserver.disconnect();
        nextObserver = null;
        track.remove();
      ...
      const tryBack = () => {
        var _a2, _b2, _c2;
        const progress = (_c2 = (_b2 = (_a2 = anyWin.Spicetify) == null ? void 0 : _a2.Player) == null ? void 0 : _b2.getProgress) == null ? void 0 : _c2.call(_b2);
      ...
      const onPointerDown = (e) => {
        ...
        if (target == null ? void 0 : target.closest('[data-testid="control-button-skip-forward"]')) {
          markManualSkip();
          swipe("next");
        } else if (target == null ? void 0 : target.closest('[data-testid="control-button-skip-back"]')) {
          tryBack();
        }
      };
      const onKeyDown = (e) => {
      ...
      if ((_c = anyWin.Spicetify) == null ? void 0 : _c.Player) {
        origNext = Spicetify.Player.next.bind(Spicetify.Player);
        origBack = Spicetify.Player.back.bind(Spicetify.Player);
        Spicetify.Player.next = (...a) => {
          markManualSkip();
          swipe("next");
          return origNext(...a);
        };
        Spicetify.Player.back = (...a) => {
          tryBack();
          return origBack(...a);
        };
      ...
      const cinemaPoll = setInterval(() => {
        ...
        const shouldMount = !cinemaActive && !!container;
      ...
      anyWin.__coverSwipeOff = () => {
        ...
        if (manualSkipTimer) clearTimeout(manualSkipTimer);
        unmount();
        if ((_a2 = anyWin.Spicetify) == null ? void 0 : _a2.Player) {
        ...
        (_b2 = document.getElementById(STYLE_ID)) == null ? void 0 : _b2.remove();
  ...
  function updatePlaylistHeaderCss(show) {
    ...
    let css;
    if (!show) {
      css = `.main-entityHeader-container.main-entityHeader-containerNormal { backdrop-filter: none !important; box-shadow: none !important; outline: none !important; }`;
    } else if (glowEnabled) {
      css = `.main-entityHeader-container.main-entityHeader-containerNormal { backdrop-filter: blur(1rem) !important; box-shadow: 0 0 var(--glowify-glow-blur, 25px) var(--glowify-glow-spread, 8px) var(--glowify-glow-accent, var(--accent-color)) !important; outline: none !important; }`;
    } else {
      css = `.main-entityHeader-container.main-entityHeader-containerNormal { backdrop-filter: blur(1rem) !important; box-shadow: none !important; outline: solid 1px var(--glowify-outline-accent, var(--accent-color)) !important; }`;
    }
    ...
    (function() {
      ...
      function animate() {
        ...
        for (const [img, data] of homeSvgs.entries()) {
          ...
          const shortcut = (_b = (_a = data.wrapper).closest) == null ? void 0 : _b.call(_a, ".view-homeShortcutsGrid-shortcut");
          try {
            data.wrapper.style.display = shortcut && ((_c = shortcut.matches) == null ? void 0 : _c.call(shortcut, ":hover")) ? "none" : "block";
          } catch (e) {
      ...
      Spicetify.Player.addEventListener("onplaypause", () => {
        ...
        if (wasPlaying && !isPlaying) {
          for (const [, data] of homeSvgs.entries()) {
            try {
              (_a = data.wrapper) == null ? void 0 : _a.remove();
            } catch (e) {
            }
          }
          homeSvgs.clear();
  ...
  function installNowPlayingViewCover() {
    ...
    function applyOverCanvas() {
      ...
      updateStyle(OVER_CANVAS_STYLE_ID, [
        ...
        ".Aj0SLDANBjINzpsp>video { filter: blur(" + blur + "px) !important; }"
      ].join("\n"));
    }
    function removeAll() {
  ...
  function installLyricsEnhancer() {
    ...
    function tryClick() {
      ...
      anyWin.__glowifyMehrTimer = setInterval(() => {
        const sidebar = document.querySelector(".a_fKt7xvd8od_kEb");
        if (sidebar && sidebar.getAttribute("aria-hidden") === "true") return;
        tries++;
        const btn = document.querySelector('.hGL4EJtqSKEstgcI button[data-encore-id="buttonPrimary"]');
        if (btn) {
          btn.click();
  ...
  function installNextSongCard() {
    ...
    (async function nscInit() {
      ...
      function watchBarContainer() {
        ...
        if (el && el !== lastBarContainer) {
          ...
          nscBarObserver = new MutationObserver(() => {
            ...
            cardEl.style.display = hidden ? "none" : "";
          });
      ...
      new MutationObserver(watchBarContainer).observe(document.body, { childList: true, subtree: true, attributes: true, attributeFilter: ["class"] });
      watchBarContainer();
    })();
  }
  function applyHighPerformanceMode(enabled) {
    const mode = enabled ? "on" : "off";
    localStorage.setItem("glowify-high-performance", mode);
    const css = enabled ? `.main-card-cardContainer:hover { backdrop-filter: blur(2rem) !important; }
.PromotionDefaultNative-module_card-container__Y90Vl:focus, .PromotionDefaultNative-module_card-container__Y90Vl:hover { backdrop-filter: blur(2rem) !important; }` : "";
    updateStyle("glowify-high-performance", css);
  }
  function ensureHighPerformanceModeApplied() {
    const saved = localStorage.getItem("glowify-high-performance") || "off";
    applyHighPerformanceMode(saved === "on");
  }
  function applyPopupBounceMode(enabled) {
    const mode = enabled ? "on" : "off";
    localStorage.setItem("glowify-popup-bounce", mode);
    const styleId = "popup-bounce-style";
  ...
  function ensurePopupBounceModeApplied() {
    const saved = localStorage.getItem("glowify-popup-bounce") || "on";
    applyPopupBounceMode(saved === "on");
  }
  var glowifyTranslations = {
    de: {
      ...
      saturationBoost: "S\xE4ttigungs-Boost:",
      lightnessBoost: "Helligkeits-Boost:",
      resetAll: "Zur\xFCcksetzen",
      resetConfirm: "Alle Glowify-Einstellungen auf Standardwerte zur\xFCcksetzen?",
      ...
      highPerformance: "High Performance Modus:",
      ...
      canvasCoverArt: {
        ...
        outsideTrackInfo: "Au\xDFerhalb Track-Info",
      ...
      tooltips: {
        ...
        saturationBoost: "Passt die S\xE4ttigungsst\xE4rke der dynamischen Akzentfarbe an",
        lightnessBoost: "Passt die Helligkeit der dynamischen Akzentfarbe an",
        resetAll: "Alle Glowify-Einstellungen auf Standard zur\xFCcksetzen",
        glowEffectMode: "Glow-Effekt an- oder ausschalten",
        glowSaturationBoost: "Passt die S\xE4ttigung des Glow-Effekts an (wirkt nur im Standard-Glow-Modus)",
        glowLightnessBoost: "Passt die Helligkeit des Glow-Effekts an (wirkt nur im Standard-Glow-Modus)",
        glowBlur: "Weichheit des Glow-Effekts (Blur-Radius des Box-Shadows)",
        glowSpread: "Ausbreitung des Glow-Effekts (Spread-Radius des Box-Shadows)",
        ...
        tncaShowAlways: "Cover Art immer anzeigen, auch wenn kein Canvas Video vorhanden ist",
        tncaBlur: "St\xE4rke der Unsch\xE4rfe \xFCber dem Canvas-Video",
        highPerformance: "Aktiviert Hover-Blur-Effekt auf Karten",
        popupBounce: "Bounce-Animation bei Popup-Men\xFCs ein-/ausschalten"
      },
      onboarding: {
        step1Title: "Glowify-Einstellungen",
        step1Text: "Dieser Button \xF6ffnet das Glowify-Einstellungspanel. Passe Hintergr\xFCnde, Akzentfarben, Player-Gr\xF6\xDFe, Glow-Effekt und vieles mehr an.",
        step2Title: "Entdecke deine Einstellungen",
        step2Text: "Alle Glowify-Optionen findest du hier. \xC4nderungen werden sofort gespeichert. Schlie\xDFe das Panel jederzeit mit dem \xD7-Button oder einem Klick au\xDFerhalb.",
        nextBtn: "Weiter",
        gotItBtn: "Verstanden"
      }
    },
    en: {
      ...
      lightnessBoost: "Brightness Boost:",
      resetAll: "Reset",
      resetConfirm: "Reset all Glowify settings to their defaults?",
      ...
      tooltips: {
        ...
        saturationBoost: "Adjusts the saturation intensity of the dynamic accent color",
        lightnessBoost: "Adjusts the brightness intensity of the dynamic accent color",
        resetAll: "Reset all Glowify settings back to defaults",
        glowEffectMode: "Toggle the glow effect on or off",
        glowSaturationBoost: "Adjusts the saturation of the glow effect (only applies in default glow mode)",
        glowLightnessBoost: "Adjusts the brightness of the glow effect (only applies in default glow mode)",
        glowBlur: "Softness of the glow effect (box-shadow blur radius)",
        glowSpread: "Spread of the glow effect (box-shadow spread radius)",
        ...
        tncaMode: "Shows a cover art image next to the track name in the right sidebar",
        tncaShowAlways: "Always show cover art even when no Canvas video is present",
        tncaBlur: "Blur strength over the canvas video",
        highPerformance: "Enables hover blur effect on cards",
        popupBounce: "Toggle bounce animation on popup menus"
      },
      onboarding: {
        step1Title: "Glowify Settings",
        step1Text: "This button opens the Glowify settings panel. Customize backgrounds, accent colors, player size, glow effect and much more.",
        step2Title: "Explore your Settings",
        step2Text: "All your Glowify options are right here. Changes are saved instantly. Close the panel anytime using the \xD7 button or clicking outside.",
        nextBtn: "Next",
        gotItBtn: "Got it"
      }
    },
    ru: {
      ...
      saturationBoost: "\u0423\u0441\u0438\u043B\u0435\u043D\u0438\u0435 \u043D\u0430\u0441\u044B\u0449\u0435\u043D\u043D\u043E\u0441\u0442\u0438:",
      lightnessBoost: "\u0423\u0441\u0438\u043B\u0435\u043D\u0438\u0435 \u044F\u0440\u043A\u043E\u0441\u0442\u0438:",
      resetAll: "\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C",
      resetConfirm: "\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C \u0432\u0441\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 Glowify \u043A \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u044F\u043C \u043F\u043E \u0443\u043C\u043E\u043B\u0447\u0430\u043D\u0438\u044E?",
      ...
      highPerformance: "\u0420\u0435\u0436\u0438\u043C \u0432\u044B\u0441\u043E\u043A\u043E\u0439 \u043F\u0440\u043E\u0438\u0437\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044C\u043D\u043E\u0441\u0442\u0438:",
      popupBounce: "\u0410\u043D\u0438\u043C\u0430\u0446\u0438\u044F \u0432\u0441\u043F\u043B\u044B\u0432\u0430\u044E\u0449\u0438\u0445 \u043E\u043A\u043E\u043D:",
      lyricsMode: "\u041F\u0435\u0440\u0435\u0432\u043E\u0434/\u0440\u043E\u043C\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u044F \u043B\u0438\u0440\u0438\u043A\u0438:",
      lyricsOptions: {
        off: "\u0412\u044B\u043A\u043B.",
      ...
      tooltips: {
        ...
        saturationBoost: "\u041D\u0430\u0441\u0442\u0440\u0430\u0438\u0432\u0430\u0435\u0442 \u0438\u043D\u0442\u0435\u043D\u0441\u0438\u0432\u043D\u043E\u0441\u0442\u044C \u043D\u0430\u0441\u044B\u0449\u0435\u043D\u043D\u043E\u0441\u0442\u0438 \u0434\u0438\u043D\u0430\u043C\u0438\u0447\u0435\u0441\u043A\u043E\u0433\u043E \u0446\u0432\u0435\u0442\u0430",
        lightnessBoost: "\u041D\u0430\u0441\u0442\u0440\u0430\u0438\u0432\u0430\u0435\u0442 \u0438\u043D\u0442\u0435\u043D\u0441\u0438\u0432\u043D\u043E\u0441\u0442\u044C \u044F\u0440\u043A\u043E\u0441\u0442\u0438 \u0434\u0438\u043D\u0430\u043C\u0438\u0447\u0435\u0441\u043A\u043E\u0433\u043E \u0446\u0432\u0435\u0442\u0430",
        resetAll: "\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C \u0432\u0441\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 Glowify \u043A \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u044F\u043C \u043F\u043E \u0443\u043C\u043E\u043B\u0447\u0430\u043D\u0438\u044E",
        glowEffectMode: "\u0412\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u0438\u043B\u0438 \u043E\u0442\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u044D\u0444\u0444\u0435\u043A\u0442 \u0441\u0432\u0435\u0447\u0435\u043D\u0438\u044F",
        glowSaturationBoost: "\u041D\u0430\u0441\u0442\u0440\u0430\u0438\u0432\u0430\u0435\u0442 \u043D\u0430\u0441\u044B\u0449\u0435\u043D\u043D\u043E\u0441\u0442\u044C \u044D\u0444\u0444\u0435\u043A\u0442\u0430 \u0441\u0432\u0435\u0447\u0435\u043D\u0438\u044F (\u0442\u043E\u043B\u044C\u043A\u043E \u0432 \u0441\u0442\u0430\u043D\u0434\u0430\u0440\u0442\u043D\u043E\u043C \u0440\u0435\u0436\u0438\u043C\u0435 \u0441\u0432\u0435\u0447\u0435\u043D\u0438\u044F)",
        glowLightnessBoost: "\u041D\u0430\u0441\u0442\u0440\u0430\u0438\u0432\u0430\u0435\u0442 \u044F\u0440\u043A\u043E\u0441\u0442\u044C \u044D\u0444\u0444\u0435\u043A\u0442\u0430 \u0441\u0432\u0435\u0447\u0435\u043D\u0438\u044F (\u0442\u043E\u043B\u044C\u043A\u043E \u0432 \u0441\u0442\u0430\u043D\u0434\u0430\u0440\u0442\u043D\u043E\u043C \u0440\u0435\u0436\u0438\u043C\u0435 \u0441\u0432\u0435\u0447\u0435\u043D\u0438\u044F)",
        glowBlur: "\u041C\u044F\u0433\u043A\u043E\u0441\u0442\u044C \u044D\u0444\u0444\u0435\u043A\u0442\u0430 \u0441\u0432\u0435\u0447\u0435\u043D\u0438\u044F (\u0440\u0430\u0434\u0438\u0443\u0441 \u0440\u0430\u0437\u043C\u044B\u0442\u0438\u044F box-shadow)",
        glowSpread: "\u0420\u0430\u0441\u043F\u0440\u043E\u0441\u0442\u0440\u0430\u043D\u0435\u043D\u0438\u0435 \u044D\u0444\u0444\u0435\u043A\u0442\u0430 \u0441\u0432\u0435\u0447\u0435\u043D\u0438\u044F (\u0440\u0430\u0434\u0438\u0443\u0441 spread box-shadow)",
        glowColor: "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0430 \u0446\u0432\u0435\u0442\u0430 \u0441\u0432\u0435\u0447\u0435\u043D\u0438\u044F",
        outlineColor: "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0430 \u0446\u0432\u0435\u0442\u0430 \u043E\u0431\u0432\u043E\u0434\u043A\u0438 \u0432 \u0440\u0435\u0436\u0438\u043C\u0435 \u0431\u0435\u0437 \u0441\u0432\u0435\u0447\u0435\u043D\u0438\u044F",
        ...
        playlistHeaderBox: "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C/\u0441\u043A\u0440\u044B\u0442\u044C \u0431\u043B\u043E\u043A \u0437\u0430\u0433\u043E\u043B\u043E\u0432\u043A\u0430 \u043F\u043B\u0435\u0439\u043B\u0438\u0441\u0442\u0430",
        lyricsMode: "\u0420\u0435\u0436\u0438\u043C \u043F\u0435\u0440\u0435\u0432\u043E\u0434\u0430 \u0438 \u0440\u043E\u043C\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u0438 \u043B\u0438\u0440\u0438\u043A\u0438",
        ...
        nscPosition: "\u041F\u043E\u0437\u0438\u0446\u0438\u044F \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0438 (\u0441\u043B\u0435\u0432\u0430/\u0441\u043F\u0440\u0430\u0432\u0430)",
        nscHeight: "\u0412\u044B\u0441\u043E\u0442\u0430 \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0438",
        nscMaxWidth: "\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0448\u0438\u0440\u0438\u043D\u0430 \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0438",
        nscGap: "\u041E\u0442\u0441\u0442\u0443\u043F \u043C\u0435\u0436\u0434\u0443 \u043E\u0431\u043B\u043E\u0436\u043A\u043E\u0439 \u0438 \u0442\u0435\u043A\u0441\u0442\u043E\u043C",
        ...
        tncaMode: "\u041F\u043E\u043A\u0430\u0437\u044B\u0432\u0430\u0435\u0442 \u043E\u0431\u043B\u043E\u0436\u043A\u0443 \u0440\u044F\u0434\u043E\u043C \u0441 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435\u043C \u0442\u0440\u0435\u043A\u0430 \u0432 \u043F\u0440\u0430\u0432\u043E\u0439 \u0431\u043E\u043A\u043E\u0432\u043E\u0439 \u043F\u0430\u043D\u0435\u043B\u0438",
        tncaShowAlways: "\u0412\u0441\u0435\u0433\u0434\u0430 \u043F\u043E\u043A\u0430\u0437\u044B\u0432\u0430\u0442\u044C \u043E\u0431\u043B\u043E\u0436\u043A\u0443, \u0434\u0430\u0436\u0435 \u0435\u0441\u043B\u0438 \u043D\u0435\u0442 Canvas \u0432\u0438\u0434\u0435\u043E",
        tncaBlur: "\u0421\u0438\u043B\u0430 \u0440\u0430\u0437\u043C\u044B\u0442\u0438\u044F \u043F\u043E\u0432\u0435\u0440\u0445 Canvas-\u0432\u0438\u0434\u0435\u043E",
        highPerformance: "\u0412\u043A\u043B\u044E\u0447\u0430\u0435\u0442 \u044D\u0444\u0444\u0435\u043A\u0442 \u0440\u0430\u0437\u043C\u044B\u0442\u0438\u044F \u043F\u0440\u0438 \u043D\u0430\u0432\u0435\u0434\u0435\u043D\u0438\u0438 \u043D\u0430 \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0438",
        popupBounce: "\u0412\u043A\u043B\u044E\u0447\u0438\u0442\u044C/\u0432\u044B\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u0430\u043D\u0438\u043C\u0430\u0446\u0438\u044E \u043E\u0442\u0441\u043A\u043E\u043A\u0430 \u0432\u0441\u043F\u043B\u044B\u0432\u0430\u044E\u0449\u0438\u0445 \u043C\u0435\u043D\u044E"
      },
      onboarding: {
        step1Title: "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 Glowify",
        step1Text: "\u042D\u0442\u0430 \u043A\u043D\u043E\u043F\u043A\u0430 \u043E\u0442\u043A\u0440\u044B\u0432\u0430\u0435\u0442 \u043F\u0430\u043D\u0435\u043B\u044C \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A Glowify. \u041D\u0430\u0441\u0442\u0440\u043E\u0439\u0442\u0435 \u0444\u043E\u043D\u044B, \u0430\u043A\u0446\u0435\u043D\u0442\u043D\u044B\u0435 \u0446\u0432\u0435\u0442\u0430, \u0440\u0430\u0437\u043C\u0435\u0440 \u043F\u043B\u0435\u0435\u0440\u0430, \u044D\u0444\u0444\u0435\u043A\u0442 \u0441\u0432\u0435\u0447\u0435\u043D\u0438\u044F \u0438 \u043C\u043D\u043E\u0433\u043E\u0435 \u0434\u0440\u0443\u0433\u043E\u0435.",
        step2Title: "\u0418\u0437\u0443\u0447\u0438\u0442\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438",
        step2Text: "\u0412\u0441\u0435 \u043F\u0430\u0440\u0430\u043C\u0435\u0442\u0440\u044B Glowify \u043D\u0430\u0445\u043E\u0434\u044F\u0442\u0441\u044F \u0437\u0434\u0435\u0441\u044C. \u0418\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u044F \u0441\u043E\u0445\u0440\u0430\u043D\u044F\u044E\u0442\u0441\u044F \u043C\u0433\u043D\u043E\u0432\u0435\u043D\u043D\u043E. \u0417\u0430\u043A\u0440\u043E\u0439\u0442\u0435 \u043F\u0430\u043D\u0435\u043B\u044C \u043A\u043D\u043E\u043F\u043A\u043E\u0439 \xD7 \u0438\u043B\u0438 \u043A\u043B\u0438\u043A\u043E\u043C \u0441\u043D\u0430\u0440\u0443\u0436\u0438 \u0432 \u043B\u044E\u0431\u043E\u0435 \u0432\u0440\u0435\u043C\u044F.",
        nextBtn: "\u0414\u0430\u043B\u0435\u0435",
        gotItBtn: "\u041F\u043E\u043D\u044F\u0442\u043D\u043E"
      }
    },
    es: {
      ...
      saturationBoost: "Aumento de saturaci\xF3n:",
      lightnessBoost: "Aumento de brillo:",
      resetAll: "Restablecer",
      resetConfirm: "\xBFRestablecer todos los ajustes de Glowify a los valores predeterminados?",
      ...
      glowSpread: "Difusi\xF3n del brillo (px):",
      ...
      highPerformance: "Modo de alto rendimiento:",
      popupBounce: "Popup Bounce:",
      ...
      canvasCoverArt: {
        mode: "Portada junto al nombre del tema:",
        off: "Desactivado",
        trackInfo: "Junto a la info del tema",
        outsideTrackInfo: "Fuera de la info del tema",
      ...
      tooltips: {
        ...
        saturationBoost: "Ajusta la intensidad de saturaci\xF3n del color de acento din\xE1mico",
        lightnessBoost: "Ajusta la intensidad de brillo del color de acento din\xE1mico",
        resetAll: "Restablecer todos los ajustes de Glowify a los valores predeterminados",
        glowEffectMode: "Activar o desactivar el efecto de brillo",
        glowSaturationBoost: "Ajusta la saturaci\xF3n del efecto de brillo (solo en el modo de brillo predeterminado)",
        glowLightnessBoost: "Ajusta la luminosidad del efecto de brillo (solo en el modo de brillo predeterminado)",
        glowBlur: "Suavidad del efecto de brillo (radio de desenfoque del box-shadow)",
        glowSpread: "Difusi\xF3n del efecto de brillo (radio de spread del box-shadow)",
        ...
        tncaMode: "Muestra una portada junto al nombre de la pista en la barra lateral derecha",
        tncaShowAlways: "Siempre mostrar la portada aunque no haya v\xEDdeo Canvas",
        tncaBlur: "Intensidad del desenfoque sobre el v\xEDdeo Canvas",
        highPerformance: "Activa efecto de desenfoque al pasar el cursor sobre tarjetas",
        popupBounce: "Activar/desactivar animaci\xF3n de rebote en men\xFAs emergentes"
      },
      onboarding: {
        step1Title: "Ajustes de Glowify",
        step1Text: "Este bot\xF3n abre el panel de ajustes de Glowify. Personaliza fondos, colores de acento, tama\xF1o del reproductor, efecto de brillo y mucho m\xE1s.",
        step2Title: "Explora tus ajustes",
        step2Text: "Todas tus opciones de Glowify est\xE1n aqu\xED. Los cambios se guardan al instante. Cierra el panel con el bot\xF3n \xD7 o haciendo clic fuera en cualquier momento.",
        nextBtn: "Siguiente",
        gotItBtn: "Entendido"
      }
    },
    pt: {
      ...
      saturationBoost: "Refor\xE7o de satura\xE7\xE3o:",
      lightnessBoost: "Refor\xE7o de brilho:",
      resetAll: "Redefinir",
      resetConfirm: "Redefinir todas as configura\xE7\xF5es do Glowify para os valores padr\xE3o?",
      ...
      glowSpread: "Difus\xE3o do brilho (px):",
      ...
      highPerformance: "Modo de alto desempenho:",
      popupBounce: "Popup Bounce:",
      ...
      canvasCoverArt: {
        mode: "Capa junto ao nome da faixa:",
        off: "Desativado",
        trackInfo: "Junto \xE0 info da faixa",
      ...
      tooltips: {
        ...
        saturationBoost: "Ajusta a intensidade da satura\xE7\xE3o da cor de destaque din\xE2mica",
        lightnessBoost: "Ajusta a intensidade do brilho da cor de destaque din\xE2mica",
        resetAll: "Redefinir todas as configura\xE7\xF5es do Glowify para os padr\xF5es",
        glowEffectMode: "Ativar ou desativar o efeito de brilho",
        glowSaturationBoost: "Ajusta a satura\xE7\xE3o do efeito de brilho (apenas no modo de brilho padr\xE3o)",
        glowLightnessBoost: "Ajusta a luminosidade do efeito de brilho (apenas no modo de brilho padr\xE3o)",
        glowBlur: "Suavidade do efeito de brilho (raio de desfoque do box-shadow)",
        glowSpread: "Difus\xE3o do efeito de brilho (raio de spread do box-shadow)",
        ...
        tncaMode: "Mostra uma capa ao lado do nome da faixa na barra lateral direita",
        tncaShowAlways: "Sempre mostrar a capa mesmo quando n\xE3o h\xE1 v\xEDdeo Canvas",
        tncaBlur: "Intensidade do desfoque sobre o v\xEDdeo Canvas",
        highPerformance: "Ativa efeito de desfoque ao passar o cursor sobre cart\xF5es",
        popupBounce: "Ativar/desativar anima\xE7\xE3o de salto em menus pop-up"
      },
      onboarding: {
        step1Title: "Configura\xE7\xF5es do Glowify",
        step1Text: "Este bot\xE3o abre o painel de configura\xE7\xF5es do Glowify. Personalize fundos, cores de destaque, tamanho do player, efeito de brilho e muito mais.",
        step2Title: "Explore suas configura\xE7\xF5es",
        step2Text: "Todas as op\xE7\xF5es do Glowify est\xE3o aqui. As altera\xE7\xF5es s\xE3o salvas instantaneamente. Feche o painel com o bot\xE3o \xD7 ou clicando fora a qualquer momento.",
        nextBtn: "Pr\xF3ximo",
        gotItBtn: "Entendi"
      }
    },
    tr: {
      ...
      saturationBoost: "Doygunluk art\u0131\u015F\u0131:",
      lightnessBoost: "Parlakl\u0131k art\u0131\u015F\u0131:",
      resetAll: "S\u0131f\u0131rla",
      resetConfirm: "T\xFCm Glowify ayarlar\u0131 varsay\u0131lan de\u011Ferlere s\u0131f\u0131rlans\u0131n m\u0131?",
      glowEffectMode: "Parlama modu:",
      glowSaturationBoost: "Parlama doygunlu\u011Fu:",
      glowLightnessBoost: "Parlama parlakl\u0131\u011F\u0131:",
      glowBlur: "Parlama bulan\u0131kl\u0131\u011F\u0131 (px):",
      glowSpread: "Parlama yay\u0131l\u0131m\u0131 (px):",
      ...
      highPerformance: "Y\xFCksek Performans Modu:",
      popupBounce: "Popup Bounce:",
      ...
      tooltips: {
        ...
        saturationBoost: "Dinamik vurgu renginin doygunluk yo\u011Funlu\u011Funu ayarlar",
        lightnessBoost: "Dinamik vurgu renginin parlakl\u0131k yo\u011Funlu\u011Funu ayarlar",
        resetAll: "T\xFCm Glowify ayarlar\u0131n\u0131 varsay\u0131lana s\u0131f\u0131rla",
        glowEffectMode: "Parlama efektini a\xE7/kapat",
        glowSaturationBoost: "Parlama efektinin doygunlu\u011Funu ayarlar (yaln\u0131zca varsay\u0131lan parlama modunda etkili)",
        glowLightnessBoost: "Parlama efektinin parlakl\u0131\u011F\u0131n\u0131 ayarlar (yaln\u0131zca varsay\u0131lan parlama modunda etkili)",
        glowBlur: "Parlama efektinin yumu\u015Fakl\u0131\u011F\u0131 (box-shadow bulan\u0131kl\u0131k yar\u0131\xE7ap\u0131)",
        glowSpread: "Parlama efektinin yay\u0131l\u0131m\u0131 (box-shadow spread yar\u0131\xE7ap\u0131)",
        ...
        tncaMode: "Sa\u011F kenar \xE7ubu\u011Funda par\xE7a ad\u0131n\u0131n yan\u0131nda kapak resmi g\xF6sterir",
        tncaShowAlways: "Canvas videosu olmasa bile kapak resmini her zaman g\xF6ster",
        tncaBlur: "Canvas videosu \xFCzerindeki bulan\u0131kl\u0131k g\xFCc\xFC",
        highPerformance: "Kartlarda \xFCzerine gelince bulan\u0131kl\u0131k efektini etkinle\u015Ftirir",
        popupBounce: "A\xE7\u0131l\u0131r men\xFClerde z\u0131plama animasyonunu a\xE7/kapat"
      },
      onboarding: {
        step1Title: "Glowify Ayarlar\u0131",
        step1Text: "Bu d\xFC\u011Fme Glowify ayar panelini a\xE7ar. Arka planlar\u0131, vurgu renklerini, oynat\u0131c\u0131 boyutunu, parlama efektini ve \xE7ok daha fazlas\u0131n\u0131 \xF6zelle\u015Ftir.",
        step2Title: "Ayarlar\u0131n\u0131 Ke\u015Ffet",
        step2Text: "T\xFCm Glowify se\xE7eneklerin burada. De\u011Fi\u015Fiklikler an\u0131nda kaydedilir. Paneli \xD7 d\xFC\u011Fmesiyle veya d\u0131\u015Far\u0131 t\u0131klayarak istedi\u011Fin zaman kapatabilirsin.",
        nextBtn: "\u0130leri",
        gotItBtn: "Anlad\u0131m"
      }
    },
    hi: {
      ...
      saturationBoost: "\u0938\u0902\u0924\u0943\u092A\u094D\u0924\u093F \u092C\u0942\u0938\u094D\u091F:",
      lightnessBoost: "\u091A\u092E\u0915 \u092C\u0942\u0938\u094D\u091F:",
      resetAll: "\u0930\u0940\u0938\u0947\u091F",
      resetConfirm: "\u0915\u094D\u092F\u093E \u0938\u092D\u0940 Glowify \u0938\u0947\u091F\u093F\u0902\u0917\u094D\u0938 \u0915\u094B \u0921\u093F\u092B\u093C\u0949\u0932\u094D\u091F \u092A\u0930 \u0930\u0940\u0938\u0947\u091F \u0915\u0930\u0947\u0902?",
      glowEffectMode: "\u0917\u094D\u0932\u094B \u092E\u094B\u0921:",
      glowSaturationBoost: "\u0917\u094D\u0932\u094B \u0938\u0902\u0924\u0943\u092A\u094D\u0924\u0924\u093E:",
      glowLightnessBoost: "\u0917\u094D\u0932\u094B \u091A\u092E\u0915:",
      glowBlur: "\u0917\u094D\u0932\u094B \u092C\u094D\u0932\u0930 (px):",
      glowSpread: "\u0917\u094D\u0932\u094B \u092B\u0948\u0932\u093E\u0935 (px):",
      glowColor: "\u0917\u094D\u0932\u094B \u090F\u0915\u094D\u0938\u0947\u0902\u091F \u0930\u0902\u0917:",
      outlineColor: "\u0906\u0909\u091F\u0932\u093E\u0907\u0928 \u090F\u0915\u094D\u0938\u0947\u0902\u091F \u0930\u0902\u0917:",
      background: "\u092A\u0943\u0937\u094D\u0920\u092D\u0942\u092E\u093F:",
      apbackground: "\u0915\u0932\u093E\u0915\u093E\u0930 \u092A\u0947\u091C \u092A\u0943\u0937\u094D\u0920\u092D\u0942\u092E\u093F:",
      ...
      transparentWidth: "\u092A\u093E\u0930\u0926\u0930\u094D\u0936\u0940 \u0928\u093F\u092F\u0902\u0924\u094D\u0930\u0923 \u091A\u094C\u0921\u093C\u093E\u0908:",
      transparentHeight: "\u092A\u093E\u0930\u0926\u0930\u094D\u0936\u0940 \u0928\u093F\u092F\u0902\u0924\u094D\u0930\u0923 \u090A\u0901\u091A\u093E\u0908:",
      ...
      close: "\u092C\u0902\u0926 \u0915\u0930\u0947\u0902",
      highPerformance: "\u0939\u093E\u0908 \u092A\u0930\u092B\u0949\u0930\u094D\u092E\u0947\u0902\u0938 \u092E\u094B\u0921:",
      popupBounce: "\u092A\u0949\u092A\u0905\u092A \u092C\u093E\u0909\u0902\u0938:",
      ...
      comfyCoverArt: {
        ...
        width: "\u091A\u094C\u0921\u093C\u093E\u0908 (px):",
        height: "\u090A\u0901\u091A\u093E\u0908 (px):",
        marginBottom: "\u0928\u0940\u091A\u0947 \u092E\u093E\u0930\u094D\u091C\u093F\u0928 (px):",
        marginLeft: "\u092C\u093E\u090F\u0902 \u092E\u093E\u0930\u094D\u091C\u093F\u0928 (px):",
        borderRadius: "\u0915\u0935\u0930 \u0915\u094B\u0928\u093E \u0924\u094D\u0930\u093F\u091C\u094D\u092F\u093E (px):"
      },
      nextSongCard: {
        ...
        gapPlayer: "\u092A\u094D\u0932\u0947\u092F\u0930 \u0924\u0915 \u0905\u0902\u0924\u0930\u093E\u0932 (px):",
        borderRadius: "\u092C\u0949\u0930\u094D\u0921\u0930 \u0924\u094D\u0930\u093F\u091C\u094D\u092F\u093E (px):",
        coverRadius: "\u0915\u0935\u0930 \u0924\u094D\u0930\u093F\u091C\u094D\u092F\u093E (px):"
      },
      tooltips: {
        accentColor: "\u092C\u091F\u0928 \u0914\u0930 \u0907\u0902\u091F\u0930\u0948\u0915\u094D\u091F\u093F\u0935 \u0924\u0924\u094D\u0935\u094B\u0902 \u0915\u093E \u0930\u0902\u0917",
        saturationBoost: "\u0921\u093E\u092F\u0928\u093E\u092E\u093F\u0915 \u090F\u0915\u094D\u0938\u0947\u0902\u091F \u0930\u0902\u0917 \u0915\u0940 \u0938\u0902\u0924\u0943\u092A\u094D\u0924\u093F \u0924\u0940\u0935\u094D\u0930\u0924\u093E \u0915\u094B \u0938\u092E\u093E\u092F\u094B\u091C\u093F\u0924 \u0915\u0930\u0924\u093E \u0939\u0948",
        lightnessBoost: "\u0921\u093E\u092F\u0928\u093E\u092E\u093F\u0915 \u090F\u0915\u094D\u0938\u0947\u0902\u091F \u0930\u0902\u0917 \u0915\u0940 \u091A\u092E\u0915 \u0924\u0940\u0935\u094D\u0930\u0924\u093E \u0915\u094B \u0938\u092E\u093E\u092F\u094B\u091C\u093F\u0924 \u0915\u0930\u0924\u093E \u0939\u0948",
        resetAll: "\u0938\u092D\u0940 Glowify \u0938\u0947\u091F\u093F\u0902\u0917\u094D\u0938 \u0915\u094B \u0921\u093F\u092B\u093C\u0949\u0932\u094D\u091F \u092A\u0930 \u0930\u0940\u0938\u0947\u091F \u0915\u0930\u0947\u0902",
        glowEffectMode: "\u0917\u094D\u0932\u094B \u092A\u094D\u0930\u092D\u093E\u0935 \u091A\u093E\u0932\u0942/\u092C\u0902\u0926 \u0915\u0930\u0947\u0902",
        glowSaturationBoost: "\u0917\u094D\u0932\u094B \u092A\u094D\u0930\u092D\u093E\u0935 \u0915\u0940 \u0938\u0902\u0924\u0943\u092A\u094D\u0924\u0924\u093E \u0938\u092E\u093E\u092F\u094B\u091C\u093F\u0924 \u0915\u0930\u0924\u093E \u0939\u0948 (\u0915\u0947\u0935\u0932 \u0921\u093F\u092B\u093C\u0949\u0932\u094D\u091F \u0917\u094D\u0932\u094B \u092E\u094B\u0921 \u092E\u0947\u0902)",
        glowLightnessBoost: "\u0917\u094D\u0932\u094B \u092A\u094D\u0930\u092D\u093E\u0935 \u0915\u0940 \u091A\u092E\u0915 \u0938\u092E\u093E\u092F\u094B\u091C\u093F\u0924 \u0915\u0930\u0924\u093E \u0939\u0948 (\u0915\u0947\u0935\u0932 \u0921\u093F\u092B\u093C\u0949\u0932\u094D\u091F \u0917\u094D\u0932\u094B \u092E\u094B\u0921 \u092E\u0947\u0902)",
        glowBlur: "\u0917\u094D\u0932\u094B \u092A\u094D\u0930\u092D\u093E\u0935 \u0915\u0940 \u092E\u0943\u0926\u0941\u0924\u093E (box-shadow \u092C\u094D\u0932\u0930 \u0924\u094D\u0930\u093F\u091C\u094D\u092F\u093E)",
        glowSpread: "\u0917\u094D\u0932\u094B \u092A\u094D\u0930\u092D\u093E\u0935 \u0915\u093E \u092B\u0948\u0932\u093E\u0935 (box-shadow spread \u0924\u094D\u0930\u093F\u091C\u094D\u092F\u093E)",
        glowColor: "\u0917\u094D\u0932\u094B \u092A\u094D\u0930\u092D\u093E\u0935 \u0915\u093E \u0930\u0902\u0917 \u0915\u0938\u094D\u091F\u092E\u093E\u0907\u091C\u093C \u0915\u0930\u0947\u0902",
        outlineColor: "\u0928\u094B-\u0917\u094D\u0932\u094B \u092E\u094B\u0921 \u092E\u0947\u0902 \u0906\u0909\u091F\u0932\u093E\u0907\u0928 \u0930\u0902\u0917 \u0915\u0938\u094D\u091F\u092E\u093E\u0907\u091C\u093C \u0915\u0930\u0947\u0902",
        background: "\u092A\u0943\u0937\u094D\u0920\u092D\u0942\u092E\u093F \u091B\u0935\u093F \u092E\u094B\u0921 \u091A\u0941\u0928\u0947\u0902",
        apbackground: "\u0915\u0932\u093E\u0915\u093E\u0930 \u092A\u0947\u091C \u092A\u0943\u0937\u094D\u0920\u092D\u0942\u092E\u093F \u0915\u0938\u094D\u091F\u092E\u093E\u0907\u091C\u093C \u0915\u0930\u0947\u0902",
        ...
        transparentWidth: "\u092A\u093E\u0930\u0926\u0930\u094D\u0936\u0940 \u0935\u093F\u0902\u0921\u094B \u0928\u093F\u092F\u0902\u0924\u094D\u0930\u0923 \u0915\u0940 \u091A\u094C\u0921\u093C\u093E\u0908",
        transparentHeight: "\u092A\u093E\u0930\u0926\u0930\u094D\u0936\u0940 \u0935\u093F\u0902\u0921\u094B \u0928\u093F\u092F\u0902\u0924\u094D\u0930\u0923 \u0915\u0940 \u090A\u0901\u091A\u093E\u0908",
        artistScrollBlur: "\u0915\u0932\u093E\u0915\u093E\u0930 \u092A\u0943\u0937\u094D\u0920\u094B\u0902 \u092A\u0930 \u0938\u094D\u0915\u094D\u0930\u0949\u0932 \u092A\u0930 \u0927\u0941\u0902\u0927\u0932\u093E\u092A\u0928",
        artistScrollBrightness: "\u0915\u0932\u093E\u0915\u093E\u0930 \u092A\u0943\u0937\u094D\u0920\u094B\u0902 \u092A\u0930 \u0938\u094D\u0915\u094D\u0930\u0949\u0932 \u092A\u0930 \u091A\u092E\u0915",
        playlistHeaderBox: "\u092A\u094D\u0932\u0947\u0932\u093F\u0938\u094D\u091F \u0939\u0947\u0921\u0930 \u092C\u0949\u0915\u094D\u0938 \u0926\u093F\u0916\u093E\u090F\u0902/\u091B\u093F\u092A\u093E\u090F\u0902",
        lyricsMode: "\u0917\u0940\u0924 \u0915\u0947 \u0932\u093F\u090F \u0905\u0928\u0941\u0935\u093E\u0926 \u0914\u0930 \u0930\u094B\u092E\u0928\u0940\u0915\u0930\u0923 \u092E\u094B\u0921",
        playerCustomWidth: "\u0915\u0938\u094D\u091F\u092E \u092A\u094D\u0932\u0947\u092F\u0930 \u091A\u094C\u0921\u093C\u093E\u0908 \u092A\u094D\u0930\u0924\u093F\u0936\u0924 \u092E\u0947\u0902",
        playerCustomHeight: "\u0915\u0938\u094D\u091F\u092E \u092A\u094D\u0932\u0947\u092F\u0930 \u090A\u0901\u091A\u093E\u0908 \u092A\u093F\u0915\u094D\u0938\u0947\u0932 \u092E\u0947\u0902",
        comfyCoverArtEnabled: "\u092A\u094D\u0932\u0947\u092F\u0930 \u092E\u0947\u0902 \u0915\u0935\u0930 \u0906\u0930\u094D\u091F \u0926\u093F\u0916\u093E\u090F\u0902/\u091B\u093F\u092A\u093E\u090F\u0902",
        comfyCoverArtWidth: "\u0915\u0935\u0930 \u0906\u0930\u094D\u091F \u091B\u0935\u093F \u0915\u0940 \u091A\u094C\u0921\u093C\u093E\u0908",
        comfyCoverArtHeight: "\u0915\u0935\u0930 \u0906\u0930\u094D\u091F \u091B\u0935\u093F \u0915\u0940 \u090A\u0901\u091A\u093E\u0908",
        comfyCoverArtMarginBottom: "\u0928\u0940\u091A\u0947 \u0911\u092B\u0938\u0947\u091F",
        comfyCoverArtMarginLeft: "\u092C\u093E\u092F\u093E\u0902 \u0911\u092B\u0938\u0947\u091F",
        comfyCoverArtBorderRadius: "\u0915\u0935\u0930 \u092C\u0949\u0930\u094D\u0921\u0930 \u0924\u094D\u0930\u093F\u091C\u094D\u092F\u093E",
        nscShow: "\u0905\u0917\u0932\u093E \u0917\u093E\u0928\u093E \u0915\u093E\u0930\u094D\u0921 \u0926\u093F\u0916\u093E\u090F\u0902/\u091B\u093F\u092A\u093E\u090F\u0902",
        nscPosition: "\u0915\u093E\u0930\u094D\u0921 \u0915\u0940 \u0938\u094D\u0925\u093F\u0924\u093F (\u092C\u093E\u090F\u0902/\u0926\u093E\u090F\u0902)",
        nscHeight: "\u0915\u093E\u0930\u094D\u0921 \u0915\u0940 \u090A\u0901\u091A\u093E\u0908",
        nscMaxWidth: "\u0915\u093E\u0930\u094D\u0921 \u0915\u0940 \u0905\u0927\u093F\u0915\u0924\u092E \u091A\u094C\u0921\u093C\u093E\u0908",
        nscGap: "\u0915\u0935\u0930 \u0914\u0930 \u091F\u0947\u0915\u094D\u0938\u094D\u091F \u0915\u0947 \u092C\u0940\u091A \u0915\u093E \u0905\u0902\u0924\u0930\u093E\u0932",
        nscCoverSize: "\u0915\u0935\u0930 \u091B\u0935\u093F \u0915\u093E \u0906\u0915\u093E\u0930",
        nscHpad: "\u0915\u093E\u0930\u094D\u0921 \u0915\u093E \u0915\u094D\u0937\u0948\u0924\u093F\u091C \u092A\u0948\u0921\u093F\u0902\u0917",
        nscVpad: "\u0915\u093E\u0930\u094D\u0921 \u0915\u093E \u0932\u0902\u092C\u0935\u0924 \u092A\u0948\u0921\u093F\u0902\u0917",
        nscGapPlayer: "\u092A\u094D\u0932\u0947\u092F\u0930 \u0924\u0915 \u0915\u093E \u0905\u0902\u0924\u0930",
        nscBorderRadius: "\u0915\u093E\u0930\u094D\u0921 \u0915\u0940 \u0915\u094B\u0928\u093E \u0917\u094B\u0932\u093E\u0908",
        nscCoverRadius: "NSC \u0915\u0935\u0930 \u0917\u094B\u0932\u093E\u0908",
        tncaMode: "\u0926\u093E\u090F\u0902 \u0938\u093E\u0907\u0921\u092C\u093E\u0930 \u092E\u0947\u0902 \u091F\u094D\u0930\u0948\u0915 \u0928\u093E\u092E \u0915\u0947 \u092C\u0917\u0932 \u092E\u0947\u0902 \u0915\u0935\u0930 \u0906\u0930\u094D\u091F \u091B\u0935\u093F \u0926\u093F\u0916\u093E\u0924\u093E \u0939\u0948",
        tncaShowAlways: "Canvas \u0935\u0940\u0921\u093F\u092F\u094B \u0928 \u0939\u094B\u0928\u0947 \u092A\u0930 \u092D\u0940 \u0939\u092E\u0947\u0936\u093E \u0915\u0935\u0930 \u0906\u0930\u094D\u091F \u0926\u093F\u0916\u093E\u090F\u0902",
        tncaBlur: "Canvas \u0935\u0940\u0921\u093F\u092F\u094B \u092A\u0930 \u0927\u0941\u0902\u0927\u0932\u093E\u092A\u0928 \u0915\u0940 \u0924\u0940\u0935\u094D\u0930\u0924\u093E",
        highPerformance: "\u0915\u093E\u0930\u094D\u0921 \u092A\u0930 \u0939\u094B\u0935\u0930 \u092C\u094D\u0932\u0930 \u092A\u094D\u0930\u092D\u093E\u0935 \u0938\u0915\u094D\u0937\u092E \u0915\u0930\u0947\u0902",
        popupBounce: "\u092A\u0949\u092A\u0905\u092A \u092E\u0947\u0928\u0942 \u092E\u0947\u0902 \u092C\u093E\u0909\u0902\u0938 \u090F\u0928\u093F\u092E\u0947\u0936\u0928 \u091A\u093E\u0932\u0942/\u092C\u0902\u0926 \u0915\u0930\u0947\u0902"
      },
      onboarding: {
        step1Title: "Glowify \u0938\u0947\u091F\u093F\u0902\u0917\u094D\u0938",
        step1Text: "\u092F\u0939 \u092C\u091F\u0928 Glowify \u0938\u0947\u091F\u093F\u0902\u0917\u094D\u0938 \u092A\u0948\u0928\u0932 \u0916\u094B\u0932\u0924\u093E \u0939\u0948\u0964 \u092A\u0943\u0937\u094D\u0920\u092D\u0942\u092E\u093F, \u090F\u0915\u094D\u0938\u0947\u0902\u091F \u0930\u0902\u0917, \u092A\u094D\u0932\u0947\u092F\u0930 \u0906\u0915\u093E\u0930, \u0917\u094D\u0932\u094B \u092A\u094D\u0930\u092D\u093E\u0935 \u0914\u0930 \u092C\u0939\u0941\u0924 \u0915\u0941\u091B \u0905\u0928\u0941\u0915\u0942\u0932\u093F\u0924 \u0915\u0930\u0947\u0902\u0964",
        step2Title: "\u0905\u092A\u0928\u0940 \u0938\u0947\u091F\u093F\u0902\u0917\u094D\u0938 \u0926\u0947\u0916\u0947\u0902",
        step2Text: "\u0906\u092A\u0915\u0947 \u0938\u092D\u0940 Glowify \u0935\u093F\u0915\u0932\u094D\u092A \u092F\u0939\u093E\u0901 \u0939\u0948\u0902\u0964 \u092A\u0930\u093F\u0935\u0930\u094D\u0924\u0928 \u0924\u0941\u0930\u0902\u0924 \u0938\u0939\u0947\u091C\u0947 \u091C\u093E\u0924\u0947 \u0939\u0948\u0902\u0964 \u092A\u0948\u0928\u0932 \u0915\u094B \xD7 \u092C\u091F\u0928 \u0938\u0947 \u092F\u093E \u092C\u093E\u0939\u0930 \u0915\u094D\u0932\u093F\u0915 \u0915\u0930\u0915\u0947 \u0915\u092D\u0940 \u092D\u0940 \u092C\u0902\u0926 \u0915\u0930\u0947\u0902\u0964",
        nextBtn: "\u0906\u0917\u0947",
        gotItBtn: "\u0938\u092E\u091D \u0917\u092F\u093E"
      }
    },
    sv: {
      ...
      saturationBoost: "M\xE4ttnadsboost:",
      lightnessBoost: "Ljusstyrkeboost:",
      resetAll: "\xC5terst\xE4ll",
      resetConfirm: "\xC5terst\xE4ll alla Glowify-inst\xE4llningar till standardv\xE4rden?",
      glowEffectMode: "Gl\xF6dl\xE4ge:",
      glowSaturationBoost: "Gl\xF6dm\xE4ttnad:",
      glowLightnessBoost: "Gl\xF6dljusstyrka:",
      glowBlur: "Gl\xF6dosk\xE4rpa (px):",
      glowSpread: "Gl\xF6dspridning (px):",
      ...
      highPerformance: "H\xF6gpresterande l\xE4ge:",
      popupBounce: "Popup Bounce:",
      ...
      tooltips: {
        ...
        saturationBoost: "Justerar m\xE4ttnadsintensiteten f\xF6r den dynamiska accentf\xE4rgen",
        lightnessBoost: "Justerar ljusstyrkan f\xF6r den dynamiska accentf\xE4rgen",
        resetAll: "\xC5terst\xE4ll alla Glowify-inst\xE4llningar till standardv\xE4rden",
        glowEffectMode: "Sl\xE5 p\xE5/av gl\xF6deffekten",
        glowSaturationBoost: "Justerar gl\xF6deffektens m\xE4ttnad (endast i standardgl\xF6dl\xE4get)",
        glowLightnessBoost: "Justerar gl\xF6deffektens ljusstyrka (endast i standardgl\xF6dl\xE4get)",
        glowBlur: "Mjukhet f\xF6r gl\xF6deffekten (box-shadow osk\xE4rperadie)",
        glowSpread: "Spridning av gl\xF6deffekten (box-shadow spridningsradie)",
        ...
        tncaMode: "Visar ett omslag bredvid sp\xE5rnamnet i den h\xF6gra sidopanelen",
        tncaShowAlways: "Visa alltid omslagskonst \xE4ven n\xE4r ingen Canvas-video finns",
        tncaBlur: "Styrka p\xE5 osk\xE4rpan \xF6ver Canvas-videon",
        highPerformance: "Aktiverar hover-blur-effekt p\xE5 kort",
        popupBounce: "Sl\xE5 p\xE5/av studsanimation p\xE5 popup-menyer"
      },
      onboarding: {
        step1Title: "Glowify-inst\xE4llningar",
        step1Text: "Den h\xE4r knappen \xF6ppnar Glowify-inst\xE4llningspanelen. Anpassa bakgrunder, accentf\xE4rger, spelarstorlek, glow-effekt och mycket mer.",
        step2Title: "Utforska dina inst\xE4llningar",
        step2Text: "Alla dina Glowify-alternativ finns h\xE4r. \xC4ndringar sparas direkt. St\xE4ng panelen med \xD7-knappen eller genom att klicka utanf\xF6r n\xE4r som helst.",
        nextBtn: "N\xE4sta",
        gotItBtn: "Uppfattat"
      }
    },
    ja: {
      ...
      title: "Glowify \u8A2D\u5B9A",
      accentColor: "\u30DC\u30BF\u30F3\u30A2\u30AF\u30BB\u30F3\u30C8\u8272:",
      saturationBoost: "\u5F69\u5EA6\u30D6\u30FC\u30B9\u30C8:",
      lightnessBoost: "\u660E\u5EA6\u30D6\u30FC\u30B9\u30C8:",
      resetAll: "\u30EA\u30BB\u30C3\u30C8",
      resetConfirm: "\u3059\u3079\u3066\u306E Glowify \u8A2D\u5B9A\u3092\u65E2\u5B9A\u5024\u306B\u623B\u3057\u307E\u3059\u304B\uFF1F",
      glowEffectMode: "\u30B0\u30ED\u30FC\u30E2\u30FC\u30C9:",
      glowSaturationBoost: "\u30B0\u30ED\u30FC\u5F69\u5EA6:",
      glowLightnessBoost: "\u30B0\u30ED\u30FC\u660E\u308B\u3055:",
      glowBlur: "\u30B0\u30ED\u30FC\u307C\u304B\u3057 (px):",
      glowSpread: "\u30B0\u30ED\u30FC\u62E1\u6563 (px):",
      glowColor: "\u30B0\u30ED\u30FC\u30A2\u30AF\u30BB\u30F3\u30C8\u8272:",
      ...
      chooseFile: "\u30D5\u30A1\u30A4\u30EB\u3092\u9078\u629E",
      enterUrl: "\u753B\u50CFURL\u3092\u5165\u529B...",
      highPerformance: "\u9AD8\u30D1\u30D5\u30A9\u30FC\u30DE\u30F3\u30B9\u30E2\u30FC\u30C9:",
      popupBounce: "\u30DD\u30C3\u30D7\u30A2\u30C3\u30D7\u30D0\u30A6\u30F3\u30B9:",
      ...
      canvasCoverArt: {
        ...
        off: "\u30AA\u30D5",
        trackInfo: "\u66F2\u60C5\u5831\u306E\u6A2A",
        outsideTrackInfo: "\u66F2\u60C5\u5831\u306E\u5916\u5074",
        overCanvas: "Canvas \u306E\u4E0A",
        showAlways: "\u5E38\u306B\u8868\u793A:",
        yes: "\u306F\u3044",
        no: "\u3044\u3044\u3048",
        blur: "\u307C\u304B\u3057 (px):"
      ...
      nextSongCard: {
        ...
        hpad: "\u6C34\u5E73\u30D1\u30C7\u30A3\u30F3\u30B0 (px):",
        vpad: "\u5782\u76F4\u30D1\u30C7\u30A3\u30F3\u30B0 (px):",
        gapPlayer: "\u30D7\u30EC\u30FC\u30E4\u30FC\u307E\u3067\u306E\u9593\u9694 (px):",
        borderRadius: "\u89D2\u306E\u4E38\u307F (px):",
        coverRadius: "\u30AB\u30D0\u30FC\u4E38\u307F (px):"
      },
      tooltips: {
        accentColor: "\u30DC\u30BF\u30F3\u3084\u30A4\u30F3\u30BF\u30E9\u30AF\u30C6\u30A3\u30D6\u8981\u7D20\u306E\u8272",
        saturationBoost: "\u30C0\u30A4\u30CA\u30DF\u30C3\u30AF\u30A2\u30AF\u30BB\u30F3\u30C8\u8272\u306E\u5F69\u5EA6\u5F37\u5EA6\u3092\u8ABF\u6574\u3057\u307E\u3059",
        lightnessBoost: "\u30C0\u30A4\u30CA\u30DF\u30C3\u30AF\u30A2\u30AF\u30BB\u30F3\u30C8\u8272\u306E\u660E\u5EA6\u5F37\u5EA6\u3092\u8ABF\u6574\u3057\u307E\u3059",
        resetAll: "\u3059\u3079\u3066\u306E Glowify \u8A2D\u5B9A\u3092\u65E2\u5B9A\u5024\u306B\u623B\u3057\u307E\u3059",
        glowEffectMode: "\u30B0\u30ED\u30FC\u52B9\u679C\u306E\u30AA\u30F3/\u30AA\u30D5",
        glowSaturationBoost: "\u30B0\u30ED\u30FC\u52B9\u679C\u306E\u5F69\u5EA6\u3092\u8ABF\u6574 (\u6A19\u6E96\u30B0\u30ED\u30FC\u30E2\u30FC\u30C9\u306E\u307F)",
        glowLightnessBoost: "\u30B0\u30ED\u30FC\u52B9\u679C\u306E\u660E\u308B\u3055\u3092\u8ABF\u6574 (\u6A19\u6E96\u30B0\u30ED\u30FC\u30E2\u30FC\u30C9\u306E\u307F)",
        glowBlur: "\u30B0\u30ED\u30FC\u52B9\u679C\u306E\u67D4\u3089\u304B\u3055 (box-shadow \u306E\u307C\u304B\u3057\u534A\u5F84)",
        glowSpread: "\u30B0\u30ED\u30FC\u52B9\u679C\u306E\u5E83\u304C\u308A (box-shadow \u306E\u30B9\u30D7\u30EC\u30C3\u30C9\u534A\u5F84)",
        glowColor: "\u30B0\u30ED\u30FC\u52B9\u679C\u306E\u8272\u3092\u30AB\u30B9\u30BF\u30DE\u30A4\u30BA",
        outlineColor: "\u30B0\u30ED\u30FC\u306A\u3057\u30E2\u30FC\u30C9\u306E\u30A2\u30A6\u30C8\u30E9\u30A4\u30F3\u8272\u3092\u30AB\u30B9\u30BF\u30DE\u30A4\u30BA",
        background: "\u80CC\u666F\u753B\u50CF\u30E2\u30FC\u30C9\u3092\u9078\u629E",
        apbackground: "\u30A2\u30FC\u30C6\u30A3\u30B9\u30C8\u30DA\u30FC\u30B8\u80CC\u666F\u3092\u30AB\u30B9\u30BF\u30DE\u30A4\u30BA",
        playerWidth: "\u30D7\u30EC\u30FC\u30E4\u30FC\u306E\u5E45\u3092\u5909\u66F4",
        playerRadius: "\u30D7\u30EC\u30FC\u30E4\u30FC\u306E\u89D2\u306E\u4E38\u307F",
        backgroundBlur: "\u80CC\u666F\u307C\u304B\u3057\u306E\u5F37\u5EA6",
        backgroundBrightness: "\u80CC\u666F\u753B\u50CF\u306E\u660E\u308B\u3055",
        transparentWidth: "\u900F\u660E\u30A6\u30A3\u30F3\u30C9\u30A6\u30B3\u30F3\u30C8\u30ED\u30FC\u30EB\u306E\u5E45",
        transparentHeight: "\u900F\u660E\u30A6\u30A3\u30F3\u30C9\u30A6\u30B3\u30F3\u30C8\u30ED\u30FC\u30EB\u306E\u9AD8\u3055",
        artistScrollBlur: "\u30A2\u30FC\u30C6\u30A3\u30B9\u30C8\u30DA\u30FC\u30B8\u3067\u306E\u30B9\u30AF\u30ED\u30FC\u30EB\u307C\u304B\u3057",
        artistScrollBrightness: "\u30A2\u30FC\u30C6\u30A3\u30B9\u30C8\u30DA\u30FC\u30B8\u3067\u306E\u30B9\u30AF\u30ED\u30FC\u30EB\u660E\u308B\u3055",
        ...
        comfyCoverArtEnabled: "\u30D7\u30EC\u30FC\u30E4\u30FC\u306E\u30AB\u30D0\u30FC\u30A2\u30FC\u30C8\u8868\u793A/\u975E\u8868\u793A",
        comfyCoverArtWidth: "\u30AB\u30D0\u30FC\u30A2\u30FC\u30C8\u753B\u50CF\u306E\u5E45",
        comfyCoverArtHeight: "\u30AB\u30D0\u30FC\u30A2\u30FC\u30C8\u753B\u50CF\u306E\u9AD8\u3055",
        comfyCoverArtMarginBottom: "\u4E0B\u30AA\u30D5\u30BB\u30C3\u30C8",
        comfyCoverArtMarginLeft: "\u5DE6\u30AA\u30D5\u30BB\u30C3\u30C8",
        comfyCoverArtBorderRadius: "\u30AB\u30D0\u30FC\u89D2\u306E\u4E38\u307F",
        nscShow: "\u6B21\u306E\u66F2\u30AB\u30FC\u30C9\u306E\u8868\u793A/\u975E\u8868\u793A",
        nscPosition: "\u30AB\u30FC\u30C9\u306E\u4F4D\u7F6E(\u5DE6/\u53F3)",
        nscHeight: "\u30AB\u30FC\u30C9\u306E\u9AD8\u3055",
        nscMaxWidth: "\u30AB\u30FC\u30C9\u306E\u6700\u5927\u5E45",
        nscGap: "\u30AB\u30D0\u30FC\u3068\u30C6\u30AD\u30B9\u30C8\u306E\u9593\u9694",
        nscCoverSize: "\u30AB\u30D0\u30FC\u753B\u50CF\u30B5\u30A4\u30BA",
        nscHpad: "\u30AB\u30FC\u30C9\u306E\u6C34\u5E73\u30D1\u30C7\u30A3\u30F3\u30B0",
        nscVpad: "\u30AB\u30FC\u30C9\u306E\u5782\u76F4\u30D1\u30C7\u30A3\u30F3\u30B0",
        nscGapPlayer: "\u30D7\u30EC\u30FC\u30E4\u30FC\u307E\u3067\u306E\u8DDD\u96E2",
        nscBorderRadius: "\u30AB\u30FC\u30C9\u89D2\u306E\u4E38\u307F",
        nscCoverRadius: "NSC \u30AB\u30D0\u30FC\u4E38\u307F",
        tncaMode: "\u53F3\u30B5\u30A4\u30C9\u30D0\u30FC\u306E\u66F2\u540D\u6A2A\u306B\u30AB\u30D0\u30FC\u30A2\u30FC\u30C8\u3092\u8868\u793A\u3057\u307E\u3059",
        tncaShowAlways: "Canvas\u52D5\u753B\u304C\u306A\u3044\u6642\u3082\u5E38\u306B\u30AB\u30D0\u30FC\u30A2\u30FC\u30C8\u3092\u8868\u793A",
        tncaBlur: "Canvas\u52D5\u753B\u4E0A\u306E\u307C\u304B\u3057\u306E\u5F37\u5EA6",
        highPerformance: "\u30AB\u30FC\u30C9\u4E0A\u306E\u30DB\u30D0\u30FC\u307C\u304B\u3057\u52B9\u679C\u3092\u6709\u52B9\u5316",
        popupBounce: "\u30DD\u30C3\u30D7\u30A2\u30C3\u30D7\u30E1\u30CB\u30E5\u30FC\u306E\u30D0\u30A6\u30F3\u30B9\u30A2\u30CB\u30E1\u30FC\u30B7\u30E7\u30F3\u306E\u30AA\u30F3/\u30AA\u30D5"
      },
      onboarding: {
        step1Title: "Glowify \u8A2D\u5B9A",
        step1Text: "\u3053\u306E\u30DC\u30BF\u30F3\u306F Glowify \u8A2D\u5B9A\u30D1\u30CD\u30EB\u3092\u958B\u304D\u307E\u3059\u3002\u80CC\u666F\u3001\u30A2\u30AF\u30BB\u30F3\u30C8\u8272\u3001\u30D7\u30EC\u30FC\u30E4\u30FC\u30B5\u30A4\u30BA\u3001\u30B0\u30ED\u30FC\u52B9\u679C\u306A\u3069\u3092\u30AB\u30B9\u30BF\u30DE\u30A4\u30BA\u3067\u304D\u307E\u3059\u3002",
        step2Title: "\u8A2D\u5B9A\u3092\u78BA\u8A8D",
        step2Text: "\u3059\u3079\u3066\u306E Glowify \u30AA\u30D7\u30B7\u30E7\u30F3\u306F\u3053\u3053\u306B\u3042\u308A\u307E\u3059\u3002\u5909\u66F4\u306F\u5373\u5EA7\u306B\u4FDD\u5B58\u3055\u308C\u307E\u3059\u3002\xD7 \u30DC\u30BF\u30F3\u307E\u305F\u306F\u5916\u5074\u3092\u30AF\u30EA\u30C3\u30AF\u3067\u3044\u3064\u3067\u3082\u9589\u3058\u3089\u308C\u307E\u3059\u3002",
        nextBtn: "\u6B21\u3078",
        gotItBtn: "\u4E86\u89E3"
      }
    },
    zh: {
      ...
      lightnessBoost: "\u4EAE\u5EA6\u589E\u5F3A:",
      resetAll: "\u91CD\u7F6E",
      resetConfirm: "\u5C06\u6240\u6709 Glowify \u8BBE\u7F6E\u91CD\u7F6E\u4E3A\u9ED8\u8BA4\u503C\uFF1F",
      glowEffectMode: "\u53D1\u5149\u6A21\u5F0F:",
      glowSaturationBoost: "\u53D1\u5149\u9971\u548C\u5EA6:",
      glowLightnessBoost: "\u53D1\u5149\u4EAE\u5EA6:",
      glowBlur: "\u53D1\u5149\u6A21\u7CCA (px):",
      glowSpread: "\u53D1\u5149\u6269\u6563 (px):",
      glowColor: "\u53D1\u5149\u5F3A\u8C03\u8272:",
      outlineColor: "\u8F6E\u5ED3\u5F3A\u8C03\u8272:",
      ...
      canvasCoverArt: {
        ...
        off: "\u5173",
        trackInfo: "\u6B4C\u66F2\u4FE1\u606F\u65C1",
        outsideTrackInfo: "\u6B4C\u66F2\u4FE1\u606F\u5916",
        overCanvas: "Canvas \u4E0A\u65B9",
        showAlways: "\u59CB\u7EC8\u663E\u793A:",
        yes: "\u662F",
        no: "\u5426",
        blur: "\u6A21\u7CCA (px):"
      ...
      tooltips: {
        ...
        saturationBoost: "\u8C03\u6574\u52A8\u6001\u5F3A\u8C03\u8272\u7684\u9971\u548C\u5EA6\u5F3A\u5EA6",
        lightnessBoost: "\u8C03\u6574\u52A8\u6001\u5F3A\u8C03\u8272\u7684\u4EAE\u5EA6\u5F3A\u5EA6",
        resetAll: "\u5C06\u6240\u6709 Glowify \u8BBE\u7F6E\u91CD\u7F6E\u4E3A\u9ED8\u8BA4\u503C",
        glowEffectMode: "\u5F00\u542F\u6216\u5173\u95ED\u53D1\u5149\u6548\u679C",
        glowSaturationBoost: "\u8C03\u6574\u53D1\u5149\u6548\u679C\u7684\u9971\u548C\u5EA6\uFF08\u4EC5\u5728\u9ED8\u8BA4\u53D1\u5149\u6A21\u5F0F\u4E0B\u751F\u6548\uFF09",
        glowLightnessBoost: "\u8C03\u6574\u53D1\u5149\u6548\u679C\u7684\u4EAE\u5EA6\uFF08\u4EC5\u5728\u9ED8\u8BA4\u53D1\u5149\u6A21\u5F0F\u4E0B\u751F\u6548\uFF09",
        glowBlur: "\u53D1\u5149\u6548\u679C\u7684\u67D4\u548C\u5EA6 (box-shadow \u7684\u6A21\u7CCA\u534A\u5F84)",
        glowSpread: "\u53D1\u5149\u6548\u679C\u7684\u6269\u6563 (box-shadow \u7684\u6269\u6563\u534A\u5F84)",
        glowColor: "\u81EA\u5B9A\u4E49\u53D1\u5149\u989C\u8272",
        outlineColor: "\u81EA\u5B9A\u4E49\u65E0\u53D1\u5149\u6A21\u5F0F\u7684\u8F6E\u5ED3\u989C\u8272",
        background: "\u9009\u62E9\u80CC\u666F\u56FE\u50CF\u6A21\u5F0F",
        apbackground: "\u81EA\u5B9A\u4E49\u827A\u672F\u5BB6\u9875\u9762\u80CC\u666F",
        playerWidth: "\u66F4\u6539\u64AD\u653E\u5668\u5BBD\u5EA6",
        playerRadius: "\u64AD\u653E\u5668\u5706\u89D2\u5927\u5C0F",
        backgroundBlur: "\u80CC\u666F\u6A21\u7CCA\u5F3A\u5EA6",
        backgroundBrightness: "\u80CC\u666F\u56FE\u50CF\u4EAE\u5EA6",
        transparentWidth: "\u900F\u660E\u7A97\u53E3\u63A7\u4EF6\u5BBD\u5EA6",
        transparentHeight: "\u900F\u660E\u7A97\u53E3\u63A7\u4EF6\u9AD8\u5EA6",
        artistScrollBlur: "\u827A\u672F\u5BB6\u9875\u9762\u6EDA\u52A8\u6A21\u7CCA",
        artistScrollBrightness: "\u827A\u672F\u5BB6\u9875\u9762\u6EDA\u52A8\u4EAE\u5EA6",
        playlistHeaderBox: "\u663E\u793A/\u9690\u85CF\u64AD\u653E\u5217\u8868\u6807\u9898\u6846",
        lyricsMode: "\u6B4C\u8BCD\u7684\u7FFB\u8BD1\u548C\u7F57\u9A6C\u5316\u6A21\u5F0F",
        playerCustomWidth: "\u81EA\u5B9A\u4E49\u64AD\u653E\u5668\u5BBD\u5EA6(\u767E\u5206\u6BD4)",
        playerCustomHeight: "\u81EA\u5B9A\u4E49\u64AD\u653E\u5668\u9AD8\u5EA6(\u50CF\u7D20)",
        comfyCoverArtEnabled: "\u663E\u793A/\u9690\u85CF\u64AD\u653E\u5668\u5C01\u9762",
        comfyCoverArtWidth: "\u5C01\u9762\u56FE\u50CF\u5BBD\u5EA6",
        comfyCoverArtHeight: "\u5C01\u9762\u56FE\u50CF\u9AD8\u5EA6",
        comfyCoverArtMarginBottom: "\u4E0B\u504F\u79FB",
        comfyCoverArtMarginLeft: "\u5DE6\u504F\u79FB",
        ...
        tncaMode: "\u5728\u53F3\u4FA7\u8FB9\u680F\u7684\u6B4C\u66F2\u540D\u79F0\u65C1\u663E\u793A\u5C01\u9762",
        tncaShowAlways: "\u5373\u4F7F\u6CA1\u6709Canvas\u89C6\u9891\u4E5F\u59CB\u7EC8\u663E\u793A\u5C01\u9762",
        tncaBlur: "Canvas\u89C6\u9891\u4E0A\u7684\u6A21\u7CCA\u5F3A\u5EA6",
        highPerformance: "\u542F\u7528\u5361\u7247\u60AC\u505C\u6A21\u7CCA\u6548\u679C",
        popupBounce: "\u5F00\u542F/\u5173\u95ED\u5F39\u7A97\u83DC\u5355\u5F39\u8DF3\u52A8\u753B"
      },
      onboarding: {
        step1Title: "Glowify \u8BBE\u7F6E",
        step1Text: "\u6B64\u6309\u94AE\u6253\u5F00 Glowify \u8BBE\u7F6E\u9762\u677F\u3002\u81EA\u5B9A\u4E49\u80CC\u666F\u3001\u5F3A\u8C03\u8272\u3001\u64AD\u653E\u5668\u5927\u5C0F\u3001\u53D1\u5149\u6548\u679C\u7B49\u3002",
        step2Title: "\u63A2\u7D22\u8BBE\u7F6E",
        step2Text: "\u6240\u6709 Glowify \u9009\u9879\u90FD\u5728\u8FD9\u91CC\u3002\u66F4\u6539\u4F1A\u7ACB\u5373\u4FDD\u5B58\u3002\u968F\u65F6\u901A\u8FC7 \xD7 \u6309\u94AE\u6216\u70B9\u51FB\u5916\u90E8\u5173\u95ED\u9762\u677F\u3002",
        nextBtn: "\u4E0B\u4E00\u6B65",
        gotItBtn: "\u660E\u767D"
      }
    },
    ko: {
      ...
      saturationBoost: "\uCC44\uB3C4 \uBD80\uC2A4\uD2B8:",
      lightnessBoost: "\uBC1D\uAE30 \uBD80\uC2A4\uD2B8:",
      resetAll: "\uCD08\uAE30\uD654",
      resetConfirm: "\uBAA8\uB4E0 Glowify \uC124\uC815\uC744 \uAE30\uBCF8\uAC12\uC73C\uB85C \uCD08\uAE30\uD654?",
      ...
      nextSongCard: {
        ...
        hpad: "\uC218\uD3C9 \uD328\uB529 (px):",
        vpad: "\uC218\uC9C1 \uD328\uB529 (px):",
        gapPlayer: "\uD50C\uB808\uC774\uC5B4\uAE4C\uC9C0 \uAC04\uACA9 (px):",
        borderRadius: "\uBAA8\uC11C\uB9AC \uB465\uAE00\uAE30 (px):",
        coverRadius: "\uCEE4\uBC84 \uB465\uAE00\uAE30 (px):"
      },
      tooltips: {
        accentColor: "\uBC84\uD2BC \uBC0F \uC778\uD130\uB799\uD2F0\uBE0C \uC694\uC18C\uC758 \uC0C9\uC0C1",
        saturationBoost: "\uB2E4\uC774\uB0B4\uBBF9 \uAC15\uC870 \uC0C9\uC0C1\uC758 \uCC44\uB3C4 \uAC15\uB3C4 \uC870\uC815",
        lightnessBoost: "\uB2E4\uC774\uB0B4\uBBF9 \uAC15\uC870 \uC0C9\uC0C1\uC758 \uBC1D\uAE30 \uAC15\uB3C4 \uC870\uC815",
        resetAll: "\uBAA8\uB4E0 Glowify \uC124\uC815\uC744 \uAE30\uBCF8\uAC12\uC73C\uB85C \uCD08\uAE30\uD654",
        glowEffectMode: "\uAE00\uB85C\uC6B0 \uD6A8\uACFC \uCF1C\uAE30/\uB044\uAE30",
        glowSaturationBoost: "\uAE00\uB85C\uC6B0 \uD6A8\uACFC\uC758 \uCC44\uB3C4 \uC870\uC815 (\uAE30\uBCF8 \uAE00\uB85C\uC6B0 \uBAA8\uB4DC\uC5D0\uC11C\uB9CC \uC801\uC6A9)",
        glowLightnessBoost: "\uAE00\uB85C\uC6B0 \uD6A8\uACFC\uC758 \uBC1D\uAE30 \uC870\uC815 (\uAE30\uBCF8 \uAE00\uB85C\uC6B0 \uBAA8\uB4DC\uC5D0\uC11C\uB9CC \uC801\uC6A9)",
        glowBlur: "\uAE00\uB85C\uC6B0 \uD6A8\uACFC\uC758 \uBD80\uB4DC\uB7EC\uC6C0 (box-shadow \uD750\uB9BC \uBC18\uACBD)",
        glowSpread: "\uAE00\uB85C\uC6B0 \uD6A8\uACFC\uC758 \uD655\uC0B0 (box-shadow \uD655\uC0B0 \uBC18\uACBD)",
        glowColor: "\uAE00\uB85C\uC6B0 \uD6A8\uACFC \uC0C9\uC0C1 \uC0AC\uC6A9\uC790 \uC9C0\uC815",
        outlineColor: "\uAE00\uB85C\uC6B0 \uC5C6\uB294 \uBAA8\uB4DC\uC5D0\uC11C \uC544\uC6C3\uB77C\uC778 \uC0C9\uC0C1 \uC0AC\uC6A9\uC790 \uC9C0\uC815",
        background: "\uBC30\uACBD \uC774\uBBF8\uC9C0 \uBAA8\uB4DC \uC120\uD0DD",
        apbackground: "\uC544\uD2F0\uC2A4\uD2B8 \uD398\uC774\uC9C0 \uBC30\uACBD \uC0AC\uC6A9\uC790 \uC9C0\uC815",
        playerWidth: "\uD50C\uB808\uC774\uC5B4 \uB108\uBE44 \uBCC0\uACBD",
        playerRadius: "\uD50C\uB808\uC774\uC5B4 \uBAA8\uC11C\uB9AC \uB465\uAE00\uAE30",
        backgroundBlur: "\uBC30\uACBD \uD750\uB9BC \uAC15\uB3C4",
        backgroundBrightness: "\uBC30\uACBD \uC774\uBBF8\uC9C0 \uBC1D\uAE30",
        transparentWidth: "\uD22C\uBA85 \uCC3D \uCEE8\uD2B8\uB864 \uB108\uBE44",
        transparentHeight: "\uD22C\uBA85 \uCC3D \uCEE8\uD2B8\uB864 \uB192\uC774",
        artistScrollBlur: "\uC544\uD2F0\uC2A4\uD2B8 \uD398\uC774\uC9C0 \uC2A4\uD06C\uB864 \uC2DC \uD750\uB9BC",
        artistScrollBrightness: "\uC544\uD2F0\uC2A4\uD2B8 \uD398\uC774\uC9C0 \uC2A4\uD06C\uB864 \uC2DC \uBC1D\uAE30",
        playlistHeaderBox: "\uD50C\uB808\uC774\uB9AC\uC2A4\uD2B8 \uD5E4\uB354 \uBC15\uC2A4 \uD45C\uC2DC/\uC228\uAE30\uAE30",
        lyricsMode: "\uAC00\uC0AC \uBC88\uC5ED \uBC0F \uB85C\uB9C8\uC790 \uD45C\uAE30 \uBAA8\uB4DC",
        playerCustomWidth: "\uC0AC\uC6A9\uC790 \uC9C0\uC815 \uD50C\uB808\uC774\uC5B4 \uB108\uBE44 (\uBC31\uBD84\uC728)",
        playerCustomHeight: "\uC0AC\uC6A9\uC790 \uC9C0\uC815 \uD50C\uB808\uC774\uC5B4 \uB192\uC774 (\uD53D\uC140)",
        comfyCoverArtEnabled: "\uD50C\uB808\uC774\uC5B4 \uCEE4\uBC84 \uC544\uD2B8 \uD45C\uC2DC/\uC228\uAE30\uAE30",
        comfyCoverArtWidth: "\uCEE4\uBC84 \uC544\uD2B8 \uC774\uBBF8\uC9C0 \uB108\uBE44",
        comfyCoverArtHeight: "\uCEE4\uBC84 \uC544\uD2B8 \uC774\uBBF8\uC9C0 \uB192\uC774",
        comfyCoverArtMarginBottom: "\uC544\uB798 \uC624\uD504\uC14B",
        comfyCoverArtMarginLeft: "\uC67C\uCABD \uC624\uD504\uC14B",
        comfyCoverArtBorderRadius: "\uCEE4\uBC84 \uBAA8\uC11C\uB9AC \uB465\uAE00\uAE30",
        ...
        nscHpad: "\uCE74\uB4DC \uC218\uD3C9 \uD328\uB529",
        nscVpad: "\uCE74\uB4DC \uC218\uC9C1 \uD328\uB529",
        nscGapPlayer: "\uD50C\uB808\uC774\uC5B4\uAE4C\uC9C0 \uAC70\uB9AC",
        nscBorderRadius: "\uCE74\uB4DC \uBAA8\uC11C\uB9AC \uB465\uAE00\uAE30",
        nscCoverRadius: "NSC \uCEE4\uBC84 \uB465\uAE00\uAE30",
        tncaMode: "\uC6B0\uCE21 \uC0AC\uC774\uB4DC\uBC14\uC758 \uD2B8\uB799 \uC774\uB984 \uC606\uC5D0 \uCEE4\uBC84 \uC544\uD2B8 \uD45C\uC2DC",
        tncaShowAlways: "Canvas \uBE44\uB514\uC624\uAC00 \uC5C6\uC5B4\uB3C4 \uD56D\uC0C1 \uCEE4\uBC84 \uD45C\uC2DC",
        tncaBlur: "Canvas \uBE44\uB514\uC624 \uC704 \uD750\uB9BC \uAC15\uB3C4",
        highPerformance: "\uCE74\uB4DC \uC704 \uD638\uBC84 \uD750\uB9BC \uD6A8\uACFC \uD65C\uC131\uD654",
        popupBounce: "\uD31D\uC5C5 \uBA54\uB274 \uBC14\uC6B4\uC2A4 \uC560\uB2C8\uBA54\uC774\uC158 \uCF1C\uAE30/\uB044\uAE30"
      },
      onboarding: {
        step1Title: "Glowify \uC124\uC815",
        step1Text: "\uC774 \uBC84\uD2BC\uC740 Glowify \uC124\uC815 \uD328\uB110\uC744 \uC5FD\uB2C8\uB2E4. \uBC30\uACBD, \uAC15\uC870 \uC0C9\uC0C1, \uD50C\uB808\uC774\uC5B4 \uD06C\uAE30, \uAE00\uB85C\uC6B0 \uD6A8\uACFC \uB4F1\uC744 \uC0AC\uC6A9\uC790 \uC9C0\uC815\uD558\uC138\uC694.",
        step2Title: "\uC124\uC815 \uB458\uB7EC\uBCF4\uAE30",
        step2Text: "\uBAA8\uB4E0 Glowify \uC635\uC158\uC774 \uC5EC\uAE30 \uC788\uC2B5\uB2C8\uB2E4. \uBCC0\uACBD\uC0AC\uD56D\uC740 \uC989\uC2DC \uC800\uC7A5\uB429\uB2C8\uB2E4. \xD7 \uBC84\uD2BC \uB610\uB294 \uBC14\uAE65 \uD074\uB9AD\uC73C\uB85C \uC5B8\uC81C\uB4E0 \uB2EB\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4.",
        nextBtn: "\uB2E4\uC74C",
        gotItBtn: "\uD655\uC778"
      }
    }
  ...
  function ensureSettingsUiStyle() {
    ...
    .glowifySettingsPanel {
      ...
      backdrop-filter: blur(2rem);
      -webkit-backdrop-filter: blur(2rem);
      box-shadow: 0 0 var(--glowify-glow-blur, 25px) var(--glowify-glow-spread, 8px) var(--glowify-glow-accent, var(--accent-color));
      position: relative;
      isolation: isolate;
    ...
    .glowifyResetBtn:hover { transform: scale(1.03); opacity: 0.9; }
    .glowifyResetBtn:active { transform: scale(0.98); }
    .glowifySettingsBody {
      flex: 1 1 auto;
      overflow-x: hidden;
      overflow-y: auto;
    ...
    .glowifyControlSurface { background: transparent; border: none; border-radius: 12px; color: white; box-shadow: 0 0 var(--glowify-glow-blur, 25px) var(--glowify-glow-spread, 8px) var(--glowify-glow-accent, var(--accent-color)); }
    .glowifySelectBtn {
      appearance: none;
      padding: 6px 10px;
      cursor: pointer;
    ...
    .glowifySelectItem:hover { background: var(--accent-color); }
    ...
    .glowifyColorSwatch { width: 20px; height: 20px; border-radius: 6px; box-shadow: 0 0 var(--glowify-glow-blur, 25px) var(--glowify-glow-spread, 8px) var(--glowify-glow-accent); }
  ...
  function SettingsContent(props) {
    ...
    const [satBoost, setSatBoost] = React.useState(readNum("glowify-accent-saturation-boost", 17));
    const [lightBoost, setLightBoost] = React.useState(readNum("glowify-accent-lightness-boost", 11));
    const [glowSatBoost, setGlowSatBoost] = React.useState(readNum("glowify-glow-saturation-boost", 17));
    const [glowLightBoost, setGlowLightBoost] = React.useState(readNum("glowify-glow-lightness-boost", 11));
    ...
    const [glowBlur, setGlowBlur] = React.useState(readNum("glowify-glow-blur", 25));
    const [glowSpread, setGlowSpread] = React.useState(readNum("glowify-glow-spread", 8));
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "glowifySettingsPanel" }, /* @__PURE__ */ React.createElement("div", { className: "glowifySettingsHeader" }, /* @__PURE__ */ React.createElement("h3", { className: "glowifySettingsTitle" }, t.title), /* @__PURE__ */ React.createElement("div", { className: "glowifyHeaderActions" }, /* @__PURE__ */ React.createElement(ButtonTooltip, { text: "Discord" }, /* @__PURE__ */ React.createElement(
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.saturationBoost || "Saturation Boost (%):", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.saturationBoost })), /* @__PURE__ */ React.createElement("div", { className: "glowifyRowControls" }, /* @__PURE__ */ React.createElement(
      Stepper,
      {
        value: satBoost,
        min: 0,
        ...
        onChange: (v2) => {
          setSatBoost(v2);
          localStorage.setItem("glowify-accent-saturation-boost", String(v2));
          window.dispatchEvent(new Event("glowifyAccentBoostChange"));
        }
      }
    ))), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.lightnessBoost || "Brightness Boost (%):", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.lightnessBoost })), /* @__PURE__ */ React.createElement("div", { className: "glowifyRowControls" }, /* @__PURE__ */ React.createElement(
      Stepper,
      {
        value: lightBoost,
        min: 0,
        ...
        onChange: (v2) => {
          setLightBoost(v2);
          localStorage.setItem("glowify-accent-lightness-boost", String(v2));
          window.dispatchEvent(new Event("glowifyAccentBoostChange"));
        }
      }
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.glowBlur || "Glow Blur (px):", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.glowBlur })), /* @__PURE__ */ React.createElement("div", { className: "glowifyRowControls" }, /* @__PURE__ */ React.createElement(
      Stepper,
      {
        value: glowBlur,
        min: 0,
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.glowSpread || "Glow Spread (px):", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.glowSpread })), /* @__PURE__ */ React.createElement("div", { className: "glowifyRowControls" }, /* @__PURE__ */ React.createElement(
      Stepper,
      {
        value: glowSpread,
        min: 0,
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.glowSaturationBoost || "Glow Saturation Boost:", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.glowSaturationBoost })), /* @__PURE__ */ React.createElement("div", { className: "glowifyRowControls" }, /* @__PURE__ */ React.createElement(
      Stepper,
      {
        value: glowSatBoost,
        min: 0,
        ...
        onChange: (v2) => {
          setGlowSatBoost(v2);
          localStorage.setItem("glowify-glow-saturation-boost", String(v2));
          window.dispatchEvent(new Event("glowifyAccentBoostChange"));
        }
      }
    ))), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.glowLightnessBoost || "Glow Brightness Boost:", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.glowLightnessBoost })), /* @__PURE__ */ React.createElement("div", { className: "glowifyRowControls" }, /* @__PURE__ */ React.createElement(
      Stepper,
      {
        value: glowLightBoost,
        min: 0,
        max: 50,
        onChange: (v2) => {
          setGlowLightBoost(v2);
          localStorage.setItem("glowify-glow-lightness-boost", String(v2));
          window.dispatchEvent(new Event("glowifyAccentBoostChange"));
        }
      }
    ...
    )))), /* @__PURE__ */ React.createElement(Section, { title: titles.ui || "UI" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.highPerformance || "High Performance Mode:", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.highPerformance })), /* @__PURE__ */ React.createElement("div", { className: "glowifyRowControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
        value: highPerformance ? "on" : "off",
        options: [
          { value: "on", label: ((_c = t.glowOnOff) == null ? void 0 : _c.on) || "On" },
          { value: "off", label: ((_d = t.glowOnOff) == null ? void 0 : _d.off) || "Off" }
        ],
        onChange: (v2) => {
          const enabled = v2 === "on";
          setHighPerformance(enabled);
          applyHighPerformanceMode(enabled);
        }
      }
    ))), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, t.popupBounce || "Popup Bounce:", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.popupBounce })), /* @__PURE__ */ React.createElement("div", { className: "glowifyRowControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
        value: popupBounceEnabled ? "on" : "off",
        options: [
          { value: "on", label: ((_e = t.glowOnOff) == null ? void 0 : _e.on) || "On" },
          { value: "off", label: ((_f = t.glowOnOff) == null ? void 0 : _f.off) || "Off" }
        ],
        onChange: (v2) => {
          const enabled = v2 === "on";
          setPopupBounceEnabled(enabled);
          applyPopupBounceMode(enabled);
        }
      }
      ...
      Select,
      {
        value: npvcMode,
        options: [
          { value: "off", label: ((_h = t.canvasCoverArt) == null ? void 0 : _h.off) || "Off" },
          { value: "trackInfo", label: ((_i = t.canvasCoverArt) == null ? void 0 : _i.trackInfo) || "Next to Track Info" },
          { value: "outsideTrackInfo", label: ((_j = t.canvasCoverArt) == null ? void 0 : _j.outsideTrackInfo) || "Outside Track Info" },
          { value: "overCanvas", label: ((_k = t.canvasCoverArt) == null ? void 0 : _k.overCanvas) || "Over Canvas" }
        ],
        onChange: (v2) => {
          setNpvcMode(v2);
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "glowifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyLabel" }, ((_l = t.canvasCoverArt) == null ? void 0 : _l.showAlways) || "Show Always:", /* @__PURE__ */ React.createElement(Tooltip, { text: tips.tncaShowAlways })), /* @__PURE__ */ React.createElement(
      Select,
      {
        value: npvcShowAlways,
        options: [
          { value: "yes", label: ((_m = t.canvasCoverArt) == null ? void 0 : _m.yes) || "Yes" },
          { value: "no", label: ((_n = t.canvasCoverArt) == null ? void 0 : _n.no) || "No" }
        ],
        onChange: (v2) => {
      ...
      Select,
      {
        value: lyricsMode,
        options: [
          { value: "off", label: ((_p = t.lyricsOptions) == null ? void 0 : _p.off) || "Aus" },
          { value: "translation", label: ((_q = t.lyricsOptions) == null ? void 0 : _q.translation) || "Nur \xDCbersetzung" },
          { value: "romanization", label: ((_r = t.lyricsOptions) == null ? void 0 : _r.romanization) || "Nur Romanisierung" },
          { value: "both", label: ((_s = t.lyricsOptions) == null ? void 0 : _s.both) || "\xDCbersetzung + Romanisierung" }
        ],
      ...
      {
        type: "button",
        className: "glowifyControlSurface glowifyResetBtn",
        onClick: () => resetAllGlowifySettings()
      },
      /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", focusable: "false", style: { width: 14, height: 14 } }, /* @__PURE__ */ React.createElement("polyline", { points: "1 4 1 10 7 10" }), /* @__PURE__ */ React.createElement("path", { d: "M3.51 15a9 9 0 1 0 2.13-9.36L1 10" })),
      /* @__PURE__ */ React.createElement("span", null, t.resetAll || "Reset")
    ))));
  }
  function ensureOnboardingStyle() {
    ...
    .glowifyObSpot {
      ...
      z-index: 100003;
      border-radius: 14px;
      box-shadow: 0 0 0 9999px rgba(0,0,0,0.72), 0 0 0 3px var(--glowify-accent, var(--accent-color, #1DB954)), 0 0 20px 4px var(--glowify-glow-accent, var(--accent-color, #1DB954));
      pointer-events: all;
      transition: all 0.35s cubic-bezier(.16,1,.3,1);
      animation: glowifyObSpotPulse 2s ease-in-out infinite;
    }
    @keyframes glowifyObSpotPulse {
      0%,100% { box-shadow: 0 0 0 9999px rgba(0,0,0,0.72), 0 0 0 3px var(--glowify-accent, var(--accent-color,#1DB954)), 0 0 16px 3px var(--glowify-glow-accent, var(--accent-color,#1DB954)); }
      50% { box-shadow: 0 0 0 9999px rgba(0,0,0,0.72), 0 0 0 3px var(--glowify-accent, var(--accent-color,#1DB954)), 0 0 32px 10px var(--glowify-glow-accent, var(--accent-color,#1DB954)); }
    }
    @keyframes glowifyObFadeIn { from { opacity: 0; } to { opacity: 1; } }
    .glowifyObCard {
      position: fixed;
      z-index: 100004;
      background: transparent;
      ...
      width: 260px;
      pointer-events: all;
      animation: glowifyObCardIn 0.4s cubic-bezier(.16,1,.3,1);
    }
    @keyframes glowifyObCardIn {
    ...
    .glowifyObArrow {
      ...
      border-bottom: 9px solid var(--glowify-glow-accent, var(--accent-color, #1DB954));
      filter: drop-shadow(0 0 6px var(--glowify-glow-accent, var(--accent-color, #1DB954)));
    }
    .glowifyObContent { margin-bottom: 14px; }
    .glowifyObTitle {
    ...
    .glowifyObActions { display: flex; justify-content: flex-end; }
    .glowifyObBtn {
      padding: 7px 16px;
      border-radius: 10px;
      ...
      background: transparent;
      color: white;
      box-shadow: 0 0 15px 4px var(--glowify-glow-accent, var(--accent-color));
    ...
    .glowifyObBtn:hover {
      ...
      box-shadow: 0 0 22px 6px var(--glowify-glow-accent, var(--accent-color));
    }
    .glowifyObDots { display: flex; gap: 6px; align-items: center; margin-bottom: 12px; }
    .glowifyObDot {
    ...
    .glowifyObDot.active {
      background: var(--glowify-accent, var(--accent-color, #1DB954));
      box-shadow: 0 0 8px 1px var(--glowify-glow-accent, var(--accent-color, #1DB954));
    }
  `;
    document.head.appendChild(style);
  }
  function GlowifyOnboarding(props) {
    ...
    React.useEffect(() => {
      ...
      if (btn) {
        const r = btn.getBoundingClientRect();
        setGearRect({ top: r.top, left: r.left, width: r.width, height: r.height, right: r.right });
      }
    }, []);
    const PAD = 10;
    ...
    const cardRight = gearRect ? Math.max(8, window.innerWidth - gearRect.right - PAD) : 16;
    const cardTop = gearRect ? gearRect.top + gearRect.height + PAD + 14 : 80;
    const handleNext = () => {
      if (step === 0) {
        setStep(1);
    ...
    const GearIcon = () => /* @__PURE__ */ React.createElement(
      "svg",
      {
        role: "img",
        viewBox: "0 0 24 24",
    ...
    const ArrowIcon = () => /* @__PURE__ */ React.createElement(
      "svg",
      {
        viewBox: "0 0 16 16",
        fill: "none",
    ...
    if (step === 0) {
      return /* @__PURE__ */ React.createElement(React.Fragment, null, gearRect && /* @__PURE__ */ React.createElement("div", { className: "glowifyObSpot", style: spotStyle }), /* @__PURE__ */ React.createElement("div", { className: "glowifyObCard", style: { top: cardTop, right: cardRight } }, /* @__PURE__ */ React.createElement("div", { className: "glowifyObArrow" }), /* @__PURE__ */ React.createElement("div", { className: "glowifyObDots" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyObDot active" }), /* @__PURE__ */ React.createElement("div", { className: "glowifyObDot" })), /* @__PURE__ */ React.createElement("div", { className: "glowifyObContent" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyObTitle" }, /* @__PURE__ */ React.createElement(GearIcon, null), ob.step1Title || "Glowify Settings"), /* @__PURE__ */ React.createElement("p", { className: "glowifyObText" }, ob.step1Text || "This button opens the Glowify settings panel. Customize backgrounds, accent colors, player size, glow effect and much more.")), /* @__PURE__ */ React.createElement("div", { className: "glowifyObActions" }, /* @__PURE__ */ React.createElement("button", { className: "glowifyObBtn", type: "button", onClick: handleNext }, ob.nextBtn || "Next", /* @__PURE__ */ React.createElement(ArrowIcon, null)))));
    }
    return /* @__PURE__ */ React.createElement("div", { className: "glowifyObStep2Card" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyObDots" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyObDot" }), /* @__PURE__ */ React.createElement("div", { className: "glowifyObDot active" })), /* @__PURE__ */ React.createElement("div", { className: "glowifyObContent" }, /* @__PURE__ */ React.createElement("div", { className: "glowifyObTitle" }, ob.step2Title || "Explore your Settings"), /* @__PURE__ */ React.createElement("p", { className: "glowifyObText" }, ob.step2Text || "All your Glowify options are right here. Changes are saved instantly. Close the panel anytime using the \xD7 button or clicking outside.")), /* @__PURE__ */ React.createElement("div", { className: "glowifyObActions" }, /* @__PURE__ */ React.createElement("button", { className: "glowifyObBtn", type: "button", onClick: handleNext }, /* @__PURE__ */ React.createElement(CheckIcon, null), ob.gotItBtn || "Got it")));
  }
  ...
  function openSettingsModal(artistCtrl) {
    ...
    ReactDOM.render(/* @__PURE__ */ React.createElement(SettingsReloader, { onClose, artistCtrl }), root);
  }
  function SettingsReloader(props) {
    const [reloadKey, setReloadKey] = React.useState(0);
    React.useEffect(() => {
      const h2 = () => setReloadKey((k) => k + 1);
      window.addEventListener("glowifySettingsReload", h2);
      return () => window.removeEventListener("glowifySettingsReload", h2);
    }, []);
    return React.createElement(SettingsContent, { key: reloadKey, onClose: props.onClose, artistCtrl: props.artistCtrl });
  }
  ...
  (async function initGlowifyStandaloneTs() {
    ...
    if (savedAccentMode === "custom") applyAccent(savedAccentColor);
      ...
      const retryInterval = setInterval(() => {
        ...
        if (cur && cur !== lastDynamicColor) {
          applyDynamicAccent();
        }
        if (++retries >= 40 || cur && cur === lastDynamicColor) clearInterval(retryInterval);
      }, 250);
      window.addEventListener("glowifyAccentColorReady", () => applyDynamicAccent(), { once: false });
