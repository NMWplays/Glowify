  ...
  function installCoverSwipe() {
    ...
    `;
      ...
      const getNextCoverUrl = () => {
        ...
        try {
          const q2 = getQueue();
          const next = ((_a2 = q2.nextTracks) == null ? void 0 : _a2[0]) || ((_b2 = q2.next_tracks) == null ? void 0 : _b2[0]);
          const url = trackToImageUrl(next);
          if (url) return url;
        } catch (e) {
        }
      ...
      const getPrevCoverUrl = () => {
        try {
          const q2 = getQueue();
          const arr = q2.prevTracks || q2.previous_tracks;
          return trackToImageUrl(arr == null ? void 0 : arr[arr.length - 1]);
        } catch (e) {
          return "";
        }
      };
      ...
      const refreshAdjacent = () => {
        const newNext = getNextCoverUrl();
        if (newNext !== nextUrl) {
          nextUrl = newNext;
          setSlot(nextSlot, nextUrl);
        }
        const newPrev = getPrevCoverUrl();
        if (newPrev !== prevUrl) {
          prevUrl = newPrev;
      ...
      const swipe = (dir) => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            if (!track) return;
            refreshAdjacent();
            const freshCur = getCurrentCoverUrl();
            if (freshCur && freshCur !== currentUrl) {
              currentUrl = freshCur;
              setSlot(currentSlot, currentUrl);
            }
          }, 150);
      ...
      const onPointerDown = (e) => {
        ...
        if (target == null ? void 0 : target.closest('[data-testid="control-button-skip-forward"]')) swipe("next");
        else if (target == null ? void 0 : target.closest('[data-testid="control-button-skip-back"]')) tryBack();
      };
      const onKeyDown = (e) => {
        if (e.ctrlKey && e.key === "ArrowRight") swipe("next");
        else if (e.ctrlKey && e.key === "ArrowLeft") tryBack();
      };
